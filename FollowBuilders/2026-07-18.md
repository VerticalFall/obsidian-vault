...
> 🇨🇳 卧槽，React复仇者集结了 https://t.co/8hqGSTOM16
...
> 🇨🇳 我们每年都会确保一些顶尖的YC AI公司在AIE上亮相。

今年，我们很荣幸邀请到@garrytan和@eve_bouff，分别面向初创企业和设计工程师群体进行分享。非常喜欢这些真实且有高度价值的观点！https://t.co/AqIFQlf0jI
...
> 🇨🇳 @mattpocockuk @trq212 @xdg的基于会话/树的grill me看起来很酷，但还没试过 https://t.co/7hFZr3S5F7 https://t.co/4cJ4ZE4Q5
...
> 🇨🇳 我仍记得那个房间，看着@stevenbjohnson讲解他如何写书。那激发了一个小项目，我们从未想过它会发展得如此庞大。

如今，超过3000万人和60万个组织在使用它，而且还在持续增长。我们都觉得这只是个开始。

有段时间，我们内部一直叫它"Notebook"。今天，我们正式对外公布这个名字。:)
...
> 🇨🇳 当修复和维护在后台进行，你的团队可以专注于构建时，更大的回报就会到来。那时你开始做以前甚至无法触及的事情。

Anthropic 处于步骤 3 并正在向步骤 4 推进。就我个人而言，我刚刚达到级别 4。

好奇你处于哪个阶段——你的团队处于哪个步骤？
...
> 🇨🇳 一旦你的团队接受，如何追踪它？使用情况值得关注（例如仪表板），但它衡量的是活动，而非回报。一个更好的问题是：你是否无论如何都会投入工程精力？如果是，投入多少，以及以人工 eng-hours 计算成本是多少？那就是你的回报。
...
> 🇨🇳 在实践中，这意味着赋予 Claude 端到端验证自身工作的能力。这意味着启用权限的自动模式，默认开启自动代码审查和安全审查，并使用允许同时管理多个 agent 的界面（CLI 中的 Agent 视图、桌面应用、iOS 和 Android 应用、Tag）。要达到更高层次，还需要 /loop、/batch、动态工作流（dynamic workflows）以及子 agent 的工作树隔离（worktree isolation）。这并非单一功能的问题，而是选择合适的特征并配合适当的防护措施...
...
> 🇨🇳 看看这个漂亮的东西 https://t.co/arLnM9smr9
...
> 🇨🇳 晚上好！我们收到了大量关于新版ChatGPT桌面应用（第一次尝试时我们做得并不完全正确）的优秀反馈，因此我们进行了一些调整。

1/ 现在聊天记录和项目会显示在侧边栏。同时，你的聊天和工作历史记录会在网页端、移动端和桌面端同步。本地任务仍保留在你的电脑上。
2/ 现在你可以在桌面上轻松切换聊天和工作模式，这也与它在其他平台上的表现保持一致...
...
希望他们能雇些靠谱的人来修复这个问题 https://t.co/3fOppcdeK0
...
> 🇨🇳 像Kimi和GLM这样的开放权重模型将引发对企业AI栈的彻底重新思考。  
如果你运营一家企业，你需要最大化模型的可选性。  
以下是你应该做的3件事：  

1. 评估 - 构建代表你用例的严格评估  
   (a) 回归评估 - 始终应具有高可靠性的基本功能  
   (b) 理想/爬山评估 - 在你价格点上最佳模型也难以解决的更难的用例。因此你搭建...
...
如果你是市场营销、销售、财务、法务或任何非工程岗位的成员，请在此处报名，与我们的团队进行30分钟的屏幕共享：https://t.co/kvc8uYzcNL
...
> 🇨🇳 谁还记得Project Tailwind还只是实验室里的一个小宝宝实验？最终它变成了NotebookLM。今天——祝贺团队成为@Gemini_Notebook！https://t.co/NmEzZJUnEi
...
> 🇨🇳 显然，蒸馏模型可以超越教师模型 😂 https://t.co/fFp5UnrBPR
...
> 🇨🇳 如果你想试试我的国际象棋引擎（仍在开发中）：https://t.co/4WJ9SYmr1o

它在国际象棋上的表现似乎已经优于前沿模型（frontier models）。

它基于200万条Stockfish标注的局面进行 fine-tune，然后经过短暂的 GRPO RL 阶段。

文档/教程包含所有实验和注释代码。https://t.co/INdb7rojHU
...
> 🇨🇳 Kimi K3 是 https://t.co/aporqgIfIh 上表现最好的模型，领先于 Fable，在更短的时间内达到了相当的成功率。

这是首个开源模型在全面网页工程基准测试中领先于所有专有模型。

说明：

▪️ 基准测试并不总能反映全貌，尽管这是一个重要信号，但越来越多的证据表明，这可能是开源模型的突破时刻。

▪️ 目前还没有模型在这组...上实现100%完成
...
> 🇨🇳 这是谁在管理这个账号 🧉 https://t.co/JjEQidasAT https://t.co/Gq2IqKJwjq
...
> 🇨🇳 我很激动地欢迎两位开发者工具领域的传奇人物——Pete Hunt（@floydophone）和Nick Schrock（@schrockn）——加入Vercel。

Pete 是 Meta @reactjs 的先驱之一。他早期押注于用 ⚛️ React 驱动 Instagram Web，并在内部和外部大力推广。他将负责 Frameworks 并领导 @nextjs。我想象不到有比他更合适的人选，能将 React 最流行的框架推向更高高度。

Nick 是 @graphql 的联合发明者，解决了数据基础设施领域一些最棘手的问题……
...
> 🇨🇳 开源模型能达到这样的性能，实在令人惊叹。祝贺Kimi团队。

每当我们降低前沿智能的成本，企业能够采用的应用场景就会增加。有大量企业希望部署的工作流，仅仅受限于tokens的成本。

对初创生态来说，重要的是，开源和闭源实验室的突破性成果相结合，使得大量价值能够积累到这一层，从而可以利用...
...
> 🇨🇳 这是AI agent让我们能够利用非结构化数据实现的一个绝佳用例。

Box现已与Databricks集成，因此你可以从企业内容（如合同、财务文档、供应链数据）中提取结构化数据，并将这些数据连接至Databricks。

这意味着我现在可以查询大型文档数据集，而无需移动或重新处理这些内容。你还可以将数据连接到任何其他系统，例如ERP数据、CRM或产品分析系统。这开启了...
...
这将是加州和美国的决定性斗争 https://t.co/IpYLoSaU5s
...
> 🇨🇳 这次与@OpenAI的@sk7037的精彩对话也可以在Spotify、Apple Podcasts以及这里的YouTube上收听

（注意：这一集音质有些问题，敬请谅解，但对话非常值得一听）
...
> 🇨🇳 "我们建得还不够快"：我与OpenAI工业计算负责人Sachin Katti (@sk7037) 关于Stargate、Jalapeno、数据中心融资以及计算相关一切的对谈。

00:00 — 冷开场："人类有史以来建造的最大项目之一"

00:30 — 欢迎：OpenAI工业计算负责人Sachin Katti

01:44 — 这是史上最大的基础设施建设吗？ 03:41 — OpenAI为何在打造新的工业能力
...
> 🇨🇳 来自中国的有趣硬件创意太多了。比如这个口罩兼作麦克风，让你在公共场所使用语音听写时不会被偷听。
...
> 🇨🇳 这是这个账号的管理者 https://t.co/5xGlSlZwTl https://t.co/ot04FHFqoq
...
> 🇨🇳 我们会给Kimi K3做个氛围检测，但我对所谓它和fable一样好的说法持极度怀疑态度。
...
> 🇨🇳 不足为奇的是，@OpenAI 现在正全力以赴，而且这是一个极其有趣的故事。

- 他们在2025年夏季推出了GPT-5，并将其定位为一对程序员。我们当时在@every上写道，他们完全错过了Claude Code中开始出现的新 agentic coding 方式。他们押注于浏览器/虚拟机中的 agentic coding 和ChatGPT中的vibe coding，但为时过早。

- 一个小团队脱离出来，开始着手开发一个独立的Codex模型系列和产品......
...
这就是我们获胜的方式 https://t.co/8iBoqvqCJx
...
> 🇨🇳 如果你有一样非常珍贵的东西……但让别人使用它却使他们能够复制它……那么也许它一开始就不是那么珍贵？
...
> 🇨🇳 我确实正在为我们的系统将模型从Fable切换出来。这不是在夸大其词……但如果有好的免费替代品，为什么要付钱呢？
...
> 🇨🇳 很多人认为，随着你越来越成功，你对“不”的拒绝听得就越少。

实际上，如果你正处在雄心的边缘挑战自我，这一说法并不成立。

在更高风险的环境下，你会频繁被拒绝。我在所有向上奋进的创始人身上都看到了这一点。

今天我就被拒绝了5次。https://t.co/d2Ws69vFQM
...
> 🇨🇳 目前我和ChatGPT说话比打字更多，新的语音模型真的突破了一个门槛。
...
> 🇨🇳 我们过去12个月的表现并非最佳，这主要是我的责任，但接下来12个月我们将迎来有史以来最好的成绩。团队正在做令人惊叹的工作，我相信你会对他们的成果感到非常满意。

我为此感到高兴有很多原因，但最主要的是我关心用户的成功。AI必须致力于赋予更多人自由、自主权和财富。我们希望做正确的事，但不想通过吓唬人来让人们接受我们的做法。
...
> 📌 播客讨论了当前AI炒作周期的本质，质疑其是否真如“电力”般革命性。核心观点：AI虽重要，但未必比互联网或移动技术更颠覆；AI实验室高管夸大失业风险存在逻辑谬误；企业采用AI面临“锯齿状能力边界”挑战；消费者AI应用尚未真正成功。

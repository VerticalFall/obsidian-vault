...
1. **Sora 2 视频克隆效果惊人，真假难辨** — X：Gabriel (@gabriel1)
...
2. **Kimi K3 登顶前端编码榜，开放权重挑战闭源双巨头** — X：阿易 AI Notes (@AYi_AInotes)
   ...
   [查看原文](https://x.com/AYi_AInotes/status/2077981025905316253)

3. **NVIDIA 发布 Nemotron 3 Embed 系列，8B 版本在 RTEB 基准上排名第一** — MarkTechPost（RSS）
   ...
   [查看原文](https://www.marktechpost.com/2026/07/17/nvidia-ai-releases-nemotron-3-embed-an-open-embedding-collection-whose-8b-checkpoint-ranks-1-on-rteb)

4. **通义实验室发布 Wan-Streamer v0.2，端到端响应延迟仅 550ms** — 公众号：通义实验室（千问）
   ...
   [查看原文](https://mp.weixin.qq.com/s/_eaO0wmsiQFGsrE2_zW_Dg)

## 📦 产品发布/更新

5. **Claude Code v2.1.212 发布** — Claude Code：GitHub Releases（RSS）
   ...
   [查看原文](https://github.com/anthropics/claude-code/releases/tag/v2.1.212)

## 🏭 行业动态

6. **Apple 起诉 OpenAI：诉讼背后是竞争焦虑还是时机博弈？** — The Verge：AI（RSS）
   ...
   [查看原文](https://www.theverge.com/podcast/967244/apple-openai-lawsuit-vergecast)

7. **苹果与 OpenAI 法律战升级：约 40 名前员工收到苹果律师函** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/978/277.htm)

## 📄 论文研究

8. **月之暗面在GTC 2026披露Kimi K2.5技术路线：用MuonClip、线性注意力与Agent Swarm重构三大基础组件** — X：宝玉 (@dotey)
   ...
   [查看原文](https://x.com/dotey/status/2078172517085085951)

9. **Schema Harness 在 ARC-AGI-3 公开集上取得约 99% 成绩** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://schema-harness.github.io/)

10. **美团LongCat发布LoHoSearch：更难搜索智能体基准** — X：美团 LongCat (@Meituan_LongCat)
   ...
   [查看原文](https://x.com/Meituan_LongCat/status/2078119654632124547)

11. **Apple 研究：Show Me Examples — 从图像集推断视觉概念** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/visual-concept-inference)

## 💡 技巧与观点

12. **八天四款前沿模型发布，Kimi K3 跻身第三** — X：Artificial Analysis (@ArtificialAnlys)
   ...
   [查看原文](https://x.com/ArtificialAnlys/status/2078165665278730490)

13. **首届“小有可为”大赛乡村教育一等奖作品“智绘科普”技术拆解** — 公众号：通义实验室（千问）
   ...
   [查看原文](https://mp.weixin.qq.com/s/a2YKWmyMoyIc3GKLbXffpQ)

14. **生成式人工智能是一场工程灾难：AI公司抢购70%高端内存，推高电脑价格** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://www.theatlantic.com/technology/2026/07/generative-ai-engineering-disaster/687901)

15. **Cursor 评估负责人确认 Claude Fable 5 在 CursorBench 达 72.9% 新高** — Claude：Blog（网页）
   ...
   [查看原文](https://claude.com/blog/working-at-the-frontier-cursor)

16. **OpenAI 提出 AI 时代记分卡：“有用智能每美元”衡量实际工作价值** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   OpenAI 提出“Useful Intelligence per Dollar”（有用智能每美元）作为衡量 AI 投资回报的核心指标，从完成的有用工作量、成功任务的实际成本、结果可靠性三个维度评估。
   [查看原文](https://openai.com/index/a-scorecard-for-the-ai-age)

17. **Anthropic 副首席信息安全官发布智能体 AI 风险评估框架：零风险不是目标** — Claude：Blog（网页）
   ...
   [查看原文](https://claude.com/blog/ciso-guide-to-agentic-ai)

18. **AI 时代“小需求”的成本逻辑变了：GitHub 博客谈工程决策新范式** — GitHub Blog
   工程师对小型功能请求的决策成本已超过代码实现成本。AI 智能体可在会议预热时间内生成首个补丁，将抽象的“是否在范围内”争论转化为可审查的具体产物。关键区分在于：代码生成便宜不等于维护便宜，只有人类能自信审查并承担长期责任的变更才算低成本。
   [查看原文](https://github.blog/engineering/the-cost-of-saying-yes-has-changed)

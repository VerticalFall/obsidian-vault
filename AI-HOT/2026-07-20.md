...
# 🔥 AI HOT 日报 · 2026-07-20

## 🧠 模型发布/更新

1. **Qwen3.8 开源发布，2.4T 参数模型上线** — X：通义千问 / Qwen (@Alibaba_Qwen)
   ...
   [查看原文](https://x.com/Alibaba_Qwen/status/2078754377473601787)

2. **昆仑万维宣布2026为“世界模型元年”，发布Matrix-Game 3.5等模型** — 公众号：昆仑万维（天工）
   ...
   [查看原文](https://mp.weixin.qq.com/s/LidvGePhOOoUY3KTor_w9g)

3. **面壁智能开源 MiniCPM-Robot 具身智能模型系列** — X：面壁智能 OpenBMB (@OpenBMB)
   ...
   [查看原文](https://x.com/OpenBMB/status/2078839529591759025)

4. **MiniCPM5-2B发布：4B以下全球性能第一，适配9款芯片** — 公众号：面壁智能（MiniCPM）
   ...
   [查看原文](https://mp.weixin.qq.com/s/rjFxrUylyGMqa5QtgypCdw)

## 📦 产品发布/更新

5. **transcribe.cpp 发布：基于 ggml 的跨平台语音转录库，支持 16 个 ASR 模型族** — Hacker News 热门（buzzing.cc 中文翻译）
   transcribe.cpp v0.1.0 发布，一个基于 ggml 的语音转录库，支持 16 个 ASR 模型族（60+ 模型），并通过 Vulkan、Metal、CUDA 和 TinyBLAS 实现 GPU 加速。
   [查看原文](https://workshop.cjpais.com/projects/transcribe-cpp)

6. **ChatGPT Work 功能：建站、邮件、文档处理** — X：Tibo (@thsottiaux)
   ...
   [查看原文](https://x.com/thsottiaux/status/2078697631019303273)

## 🏭 行业动态

7. **黄仁勋访日：Nvidia 联手日本打造物理 AI 时代，Noetra 主权 AI 工厂与 Cosmos 机器人联盟落地** — TechCrunch：AI（RSS）
   Nvidia CEO 黄仁勋在 7 月 15-16 日访日期间，宣布为日本建设“Vera Rubin AI 工厂”，配备 13,750 颗 Vera CPU 和 27,500 颗 Rubin GPU，预计 2028 年投运。
   [查看原文](https://techcrunch.com/2026/07/19/what-to-watch-for-after-jensen-huangs-japan-visit)

## 💡 技巧与观点

8. **AI 热潮正在瓦解全球决策机制** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://ludic.mataroa.blog/blog/ai-mania-is-eviscerating-global-decision-making)

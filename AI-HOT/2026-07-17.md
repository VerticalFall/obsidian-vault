...
aliases: [🔥 AI HOT 日报 · 2026-07-17]
linter-yaml-title-alias: 🔥 AI HOT 日报 · 2026-07-17
---
...
1. **Kimi K3 发布：2.8T 参数开源模型，具备原生视觉与百万 token 上下文窗口** — Moonshot AI：Kimi Blog
...
2. **Grok 推出 Automations 功能：定时或邮件触发，自动执行任务并汇报结果** — xAI：News（网页）
   ...
   [查看原文](https://x.ai/news/grok-automations)

3. **Decoy 字体：用空间频率混淆让 AI 看不清你输入的文字** — Hacker News 热门（buzzing.cc 中文翻译）
   Decoy Font 是一款 TTF 字体，通过在同一字符中叠加不同空间频率的图形（前景细轮廓与背景低频模糊块），使近距离观看时 AI 读到“诱饵”字母，而人眼远距离或眯眼时才能看到真实隐藏信息。
   [查看原文](https://www.mixfont.com/experiments/decoy-font)

4. **ChatGPT 工作区支持文档表格幻灯片编辑** — X：ChatGPT (@ChatGPTapp)
   在 ChatGPT 工作区中创建和编辑精美的文档、电子表格和幻灯片。 @nickbaumann_ 为你演示操作。
   [查看原文](https://x.com/ChatGPTapp/status/2077826846373380535)

5. **天工短剧工作台发布“Agent智能分镜+无限画布”双轨创作模式** — 公众号：昆仑万维（天工）
   ...
   [查看原文](https://mp.weixin.qq.com/s/WlGAeogkF_N5122nHA0TtQ)

6. **秒哒 3.5 全球首发 iOS App，无代码开发与多端共享后端能力升级** — 公众号：百度智能云（文心）
   ...
   [查看原文](https://mp.weixin.qq.com/s/W3QACoSYgwK0TW4zG-KFsg)

7. **面壁智能开源企业AI数字员工平台StaffDeck** — X：面壁智能 OpenBMB (@OpenBMB)
   面壁智能联合多团队开源StaffDeck，一个用于构建与管理数字员工的企业平台。该平台旨在将专业知识、标准作业程序（SOP）和决策规则转化为持续工作、改进并保留组织知识的数字员工，而非传统聊天机器人。项目代码已发布于GitHub。
   [查看原文](https://x.com/OpenBMB/status/2077741814799548451)

8. **MiniMax Code 2.0 桌面端焕新：底层架构全面升级，金融模块即将上线** — 公众号：MiniMax（稀宇科技）
   ...
   [查看原文](https://mp.weixin.qq.com/s/mQeBO0xC6Z1R0LqZX5TvNg)

9. **在 Claude Cowork 中使用 Claude Fable 5** — Claude：Blog（网页）
   Anthropic 发布最强通用模型 Claude Fable 5，专为长时间、多步骤的复杂异步工作设计，可在 Claude Cowork 中自主执行深度研究、尽职调查等任务。该模型需手动选择，默认模型为 Claude Sonnet 5。
   [查看原文](https://claude.com/blog/working-with-claude-fable-5-in-claude-cowork)

## 🏭 行业动态

10. **xAI 起诉 Grok 用户制作儿童性虐待内容，不再否认模型被滥用** — Ars Technica：AI（RSS）
   xAI 首次对一名 Grok 用户提起诉讼，指控其利用该模型制作儿童性虐待图像（CSAM）。此前 xAI 一直否认 Grok 能生成此类内容，此次诉讼标志着其立场转变。案件聚焦用户滥用行为，而非模型本身的技术缺陷。
   [查看原文](https://arstechnica.com/tech-policy/2026/07/xai-cant-deny-grok-makes-csam-anymore-so-its-suing-users)

11. **欧盟裁定 Google 必须向竞争对手开放 Android 和 Search，影响 Gemini 等 AI 服务** — The Verge：AI（RSS）
   ...
   [查看原文](https://www.theverge.com/policy/966438/eu-google-android-ai-interoperability-search-data-dma)

12. **台积电上调2026年资本支出预测至600~640亿美元，A14制程进展顺利** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/977/544.htm)

13. **世界人工智能合作组织协定签署仪式在上海举行，总部设中国上海** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/977/793.htm)

14. **54%企业已遭遇AI智能体安全事件，多数仍共享凭证** — VentureBeat：AI（RSS）
   ...
   [查看原文](https://venturebeat.com/ai/the-agent-security-gap-54-of-enterprises-have-already-had-an-ai-agent-incident-and-most-still-let-agents-share-credentials)

15. **Google DeepMind 与 Isomorphic Labs 公布生物弹性联合方案：用 AI 预防、检测和应对疫情** — Google DeepMind：Blog（RSS）
...
16. **HYPIC：小红书联合北大、上交提出首个混合注意力大模型位置无关缓存系统** — 公众号：小红书技术（dots.llm）
   HYPIC 在混合注意力大模型上实现了位置无关缓存，将首 token 延迟平均降低 3.25 倍。在 4 个生产级模型上，同 SLO 下可持续 QPS 提升 1.66 倍，任务质量与完全重算仅相差 1.71 分。
   [查看原文](https://mp.weixin.qq.com/s/RWveWvw9yBH6YQINBQ-XjA)

17. **Moonshot AI 发布 PerceptionBench：多模态模型视觉感知能力诊断基准** — Moonshot AI：Kimi Blog
...
18. **Apple 研究：Embarrassingly Simple Self-Distillation 提升代码生成能力** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/simple-self-distillation)

19. **Apple 用混合文本与 ID 嵌入实现增量视频搜索个性化排序** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/personalizing-incremental-video-search)

## 💡 技巧与观点

20. **企业AI智能体评估存在“现实对齐”缺口：半数组织曾将通过内部测试的智能体部署到生产环境后导致客户故障** — VentureBeat：AI（RSS）
   ...
   [查看原文](https://venturebeat.com/ai/the-agent-evaluation-gap-enterprise-ai-organizations-have-a-reality-alignment-problem-not-a-coverage-problem-and-most-are-shipping-to-production-anyway)

21. **Patter SDK 教程：构建餐厅预订电话智能体，支持动态变量、护栏、延迟仪表盘与评估检查** — MarkTechPost（RSS）
   ...
   [查看原文](https://www.marktechpost.com/2026/07/16/patter-sdk-guide-to-building-a-restaurant-booking-phone-agent-with-dynamic-variables-guardrails-latency-dashboards-and-eval-checks)

22. **xAI 开源 Grok CLI 代码库中发现 Mermaid 转 Unicode 框图工具** — Simon Willison 博客
   ...
   [查看原文](https://simonwillison.net/2026/Jul/16/grok-mermaid)

23. **远程操控Agent干活方案：Codex主力 + UU远程兜底** — 公众号：数字生命卡兹克
   ...
   [查看原文](https://mp.weixin.qq.com/s/x2JlkhOlGNVhL8oe7AVk9Q)

24. **Anthropic 用 Claude Code 大规模迁移代码：Bun 百万行 Zig 转 Rust，两周完成** — Claude：Blog（网页）
   ...
   [查看原文](https://claude.com/blog/ai-code-migration)

25. **千问APP联合武汉发布举办AI求职实战课，演示简历诊断与办公自动化** — 公众号：千问APP（阿里）
   ...
   [查看原文](https://mp.weixin.qq.com/s/dCk6IXbFyOSSc1JxcWsglA)

26. **Google 提出模块化提示词转译方案，构建可扩展 AI 智能体** — Google Developers Blog（RSS）
   ...
   [查看原文](https://developers.googleblog.com/building-scalable-ai-agents-with-modular-prompt-transpilation)

27. **OpenAI 强调青少年应获得安全 AI 访问权，推出 Study Mode 等保护措施** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   ...
   [查看原文](https://openai.com/index/why-teens-deserve-access-safe-ai)

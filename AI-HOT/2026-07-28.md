...
1. **Kimi K3 开源：2.8T MoE 模型与技术报告** — X：Kimi.ai (@Kimi_Moonshot)
   ...
   [查看原文](https://x.com/Kimi_Moonshot/status/2081760186235289764)
...
2. **Kimi K3 上线 Modal，支持无损加速推理** — X：Kimi.ai (@Kimi_Moonshot)
   ...
   [查看原文](https://x.com/Kimi_Moonshot/status/2081767591887122564)
...
3. **Kimi 发布视觉感知基准 PerceptionBench** — X：Kimi.ai (@Kimi_Moonshot)
   ...
   [查看原文](https://x.com/Kimi_Moonshot/status/2081813202514681878)
...
4. **SGLang 和 Miles 为月之暗面 2.8T 参数 Kimi K3 模型提供发布当日支持** — LMSYS：Blog（Chatbot Arena 团队）
   ...
   [查看原文](https://www.lmsys.org/blog/2026-07-27-kimi-k3-day0-support)
...
5. **Google AI Overviews 搜索结果出现率升至43%** — TechCrunch：AI（RSS）
   ...
   [查看原文](https://techcrunch.com/2026/07/27/googles-ai-search-is-rapidly-becoming-the-default-new-data-shows)
...
7. **Cognizant 与 Anthropic 扩大合作，成为 Claude Partner Network 全球首要合作伙伴** — Anthropic：Newsroom（网页）
   ...
   [查看原文](https://www.anthropic.com/news/cognizant-anthropic)
...
8. **Apple 提出 GH-ESD：面向实例级视觉任务的假设驱动错误切片发现方法** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/gh-esd)
...
9. **用AI Skill自动生成可协作HTML PPT** — X：Vista (@vista8)
   ...
   [查看原文](https://x.com/vista8/status/2081568902241513786)
...
10. **GitHub Copilot 发布“Harness”工作流：用单一工具完成原型、规划、实现与代码审查** — GitHub Blog
   ...
   [查看原文](https://github.blog/ai-and-ml/github-copilot/the-harness-is-all-you-need-mostly)
...
11. **用Claude和Python构建技能驱动的金融分析智能体** — MarkTechPost（RSS）
   ...
   [查看原文](https://www.marktechpost.com/2026/07/27/designing-skill-driven-financial-analysis-agents-with-claude-python-mcp-connectors-and-automated-deliverables)
...
12. **OpenAI 称越来越多员工用 ChatGPT 做其他岗位的工作** — The Decoder：AI News（RSS）
   ...
   [查看原文](https://the-decoder.com/openai-says-more-workers-are-using-chatgpt-to-do-other-peoples-jobs)
...
13. **GitHub Copilot app 入门指南：多 Agent 会话工作区与 Canvas 预览** — GitHub Blog
   ...
   [查看原文](https://github.blog/ai-and-ml/github-copilot/github-copilot-app-for-beginners-getting-started)
...
14. **浪费20亿Token后，我开源了帮Agent定义目标的Leader.skill** — 公众号：数字生命卡兹克
   ...
   [查看原文](https://mp.weixin.qq.com/s/AwOk3di8m6eVeIUjzNftgg)
...
16. **OpenRouter 新增图像生成模型专用 API 端点** — OpenRouter：Announcements（RSS）
   ...
   [查看原文](https://openrouter.ai/blog/tutorials/image-generation-models)

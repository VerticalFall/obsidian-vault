...
# 🔥 AI HOT 日报 · 2026-07-23

## 📦 产品发布/更新

1. **腾讯设计Agent平台Miora全面开放** — 公众号：数字生命卡兹克
   腾讯设计Agent平台Miora今日全面开放，无需邀请码即可使用。该平台由WorkBuddy团队打造，提供品牌设计、影视创意等五大场景模式，支持自定义多模态模型和Agent推理深度，并内置Skill市场与记忆系统。
   [查看原文](https://mp.weixin.qq.com/s/qQhq9nxoeCD68iMwQoEVFQ)

2. **GigaToken 发布：语言模型分词速度最高提升约 1000 倍，可无缝替代 HuggingFace Tokenizers** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://github.com/marcelroed/gigatoken)

3. **微软 MagenticLite 模型全面开源** — X：Microsoft Research (@MSFTResearch)
   ...
   [查看原文](https://x.com/MSFTResearch/status/2079989338994069511)

4. **Claude 新增 Anthropic Economic Index 连接器，可直接查询 AI 对经济与职业的影响数据** — Anthropic：Newsroom（网页）
   ...
   [查看原文](https://www.anthropic.com/news/anthropic-economic-index-connector)

5. **Cursor 发布智能模型路由系统 Cursor Router** — Cursor Blog
...
6. **小红书开源 BigMac：多模态大模型训练新范式** — 公众号：小红书技术（dots.llm）
   ...
   [查看原文](https://mp.weixin.qq.com/s/tNJARtn1jIayL5URg87Row)

7. **Claude Code v2.1.218 发布** — Claude Code：GitHub Releases（RSS）
   ...
   [查看原文](https://github.com/anthropics/claude-code/releases/tag/v2.1.218)

8. **三星 Galaxy Unpacked 2026：Gemini Intelligence 1 任务自动化、Gemini Notebook 及智能眼镜等三项更新** — Google Blog：AI（RSS）
   三星 Galaxy Z Fold8 Ultra、Fold8 及 Flip8 首发搭载 Gemini Intelligence 1，其任务自动化功能从少数应用扩展至超过 40 款，支持购物、订餐、预订旅行等，并新增屏幕理解与复杂图像解析能力。
   [查看原文](https://blog.google/products-and-platforms/platforms/android/galaxy-unpacked-2026)

## 🏭 行业动态

9. **AMD 投资 50 亿，Anthropic 采购 2GW GPU** — X：SemiAnalysis (@SemiAnalysis_)
   AMD 刚刚宣布与 Anthropic 达成协议，将投资高达 50 亿美元，换取 Anthropic 采购 2GW 的 AMD MI455 UALOE72 及未来 GPU。🚨 这与我们三天前关于 Anthropic 的说法一致。
   [查看原文](https://x.com/SemiAnalysis_/status/2079929602429141215)

10. **OpenAI 拟投资 200 亿美元在美新建数据中心，2030 年算力支出预期上调至近 7500 亿美元** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/980/322.htm)

11. **Alphabet Q2：AI 投资推动营收增长 24%，Gemini 月活达 9.5 亿** — X：Sundar Pichai (@sundarpichai)
   ...
   [查看原文](https://x.com/sundarpichai/status/2080021408856293584)

12. **Anthropic 设立 2 亿美元经济未来研究基金，支持外部研究** — Anthropic：Newsroom（网页）
   Anthropic 承诺投入 2 亿美元成立 Anthropic Economic Futures Research Fund，用于资助外部研究。该基金旨在支持具有前瞻性的经济影响研究项目。
   [查看原文](https://www.anthropic.com/news/economic-futures-research-fund-agenda)

13. **OpenAI 在佐治亚州 Effingham 县启动 Project Camellia 数据中心项目** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   OpenAI 宣布在佐治亚州 Effingham 县启动 Project Camellia，承诺负责任能源、社区投资、就业岗位及 Codex 访问权限。该项目聚焦 AI 基础设施建设，具体投资金额与算力规模尚未披露。
   [查看原文](https://openai.com/index/building-ai-infrastructure-with-the-effingham-county-community)

14. **OpenAI 与美国能源部及国家实验室合作，推动前沿 AI 加速科学发现** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   OpenAI 宣布与美国能源部及国家实验室合作，利用前沿 AI 加速科学发现。合作旨在推动美国科学事业进入新阶段，通过 AI 技术提升研究效率与突破速度。
   [查看原文](https://openai.com/index/advancing-the-next-era-of-national-science)

15. **Google DeepMind 为 Genesis Mission 提供 4000 万美元 AI tokens 和 credits** — Google DeepMind：Blog（RSS）
   ...
   [查看原文](https://deepmind.google/blog/accelerating-the-frontiers-of-scientific-discovery-googles-40m-commitment-to-the-genesis-mission)

## 📄 论文研究

16. **RECAP：通过可解码性监督训练可验证的激活解释** — HuggingFace Daily Papers（社区热门论文）
   ...
   [查看原文](https://arxiv.org/abs/2607.20379)

## 💡 技巧与观点

17. **从提示词到任务：多模态交互单元提升AI智能体效率** — X：Elvis Saravia (@omarsar0, DAIR.AI)
   ...
   [查看原文](https://x.com/omarsar0/status/2079982491578827214)

18. **OpenRouter 新增音频转写 API，支持 Whisper 与 token 计价 STT 模型** — OpenRouter：Announcements（RSS）
   OpenRouter 推出 POST /api/v1/audio/transcriptions 端点，用户可使用同一 API key 将 base64 编码音频发送至该端点，返回 JSON 格式文本与用量对象。
   [查看原文](https://openrouter.ai/blog/tutorials/transcription-on-openrouter)

19. **实测Qwen-Image-3.0：19大场景挑战GPT Image2，中文长文本与多图融合表现亮眼** — 公众号：卡尔的AI沃茨
   ...
   [查看原文](https://mp.weixin.qq.com/s/PnXGmmDYejrHBSpoRBOHkg)

20. **开源模型季度盘点：Kimi K3、Qwen 3.8、WAIC 演讲、知识蒸馏与开源闭源差距** — Nathan Lambert：Interconnects（RSS）
   ...
   [查看原文](https://www.interconnects.ai/p/open-models-recap-more-on-kimi-k3)

21. **在 Claude Code 中使用技能构建验证循环** — Claude：Blog（网页）
   ...
   [查看原文](https://claude.com/blog/building-verification-loops-in-claude-code-with-skills)

22. **Copilot vs. 直接 API 调用：你实际在为什么付费？** — GitHub Blog
   GitHub Copilot 现已按公布的 API 费率对使用量计费。与直接调用模型 API 相比，用户支付的额外费用覆盖了编码工作流、策略管理和工具集成等周边服务。
   [查看原文](https://github.blog/ai-and-ml/github-copilot/copilot-vs-raw-api-access-what-are-you-actually-paying-for)

23. **Outtake 在 Claude 上构建自主网络调查智能体 Recon Agent** — Claude：Blog（网页）
   AI 网络安全平台 Outtake 基于 Claude，使用 Claude Code 和 Agent SDK 构建了自主网络调查智能体 Recon Agent。
   [查看原文](https://claude.com/blog/how-outtake-built-a-cyber-investigator-on-claude)

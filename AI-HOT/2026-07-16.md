...
1. **阿里发布 Qwen-Audio-3.0-Realtime，在 Artificial Analysis 语音推理子项中综合排名第一** — 公众号：通义实验室（千问）
   ...
   [查看原文](https://mp.weixin.qq.com/s/hFp5rtV8-6KVRrgZoCj03A)
...
2. **Thinking Machines 发布多模态模型 Inkling** — X：Thinking Machines (@thinkymachines)
   ...
   [查看原文](https://x.com/thinkymachines/status/2077454609551921208)
...
4. **xAI 开源 Grok Build 编程智能体与终端界面** — xAI：News（网页）
   ...
   [查看原文](https://x.ai/news/grok-build-open-source)
...
5. **Telegram 无服务器架构** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://core.telegram.org/bots/serverless)
...
6. **开源编程智能体内存方案发布，通过 SSH 同步** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://github.com/vshulcz/deja-vu)

7. **Grok Build 现已开源** — X：Elon Musk (@elonmusk, xAI)
   Grok Build 现已开源
   [查看原文](https://x.com/elonmusk/status/2077495635687723408)
...
8. **金山办公推出 WPS Comate AI 办公客户端** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/977/105.htm)
...
9. **Claude Code 新增 MCP 连接器调用功能** — X：Claude Devs (@ClaudeDevs)
   ...
   [查看原文](https://x.com/ClaudeDevs/status/2077489907350856038)
...
10. **SGLang 与 Miles 为前沿多模态模型 Inkling 提供 Day-0 支持，推理吞吐达 71.7k tok/s** — LMSYS：Blog（Chatbot Arena 团队）
   ...
   [查看原文](https://www.lmsys.org/blog/2026-07-15-inkling-day0-support)
...
11. **国行 Apple 智能完成备案，阿里千问将集成至苹果 AI 能力** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/977/109.htm)
...
12. **阿里Qwen将集成至Apple Intelligence服务中国用户** — X：X.PIN (@thexpin)
   ...
   [查看原文](https://x.com/thexpin/status/2077346752219521469)
...
13. **Anthropic 研究：AI 智能体模拟中行为偏差** — X：Anthropic (@AnthropicAI)
   ...
   [查看原文](https://x.com/AnthropicAI/status/2077452646303006927)
...
15. **Apple 提出 LLM 函数调用不确定性量化方法** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/uncertainty-quantification-function-calling)
...
16. **Meta 探索分层兴趣表示以优化广告深度漏斗** — Meta Engineering Blog（RSS）
   ...
   [查看原文](https://engineering.fb.com/2026/07/15/ai-research/exploring-hierarchical-interest-representation-for-meta-ads-deep-funnel-optimization)
...
17. **Apple 提出 CLaRa：用连续潜在推理桥接检索与生成** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/clara-latent-reasoning)
...
18. **Airtap iMessage 新功能：发条短信让 AI 替你操作手机** — X：阿易 AI Notes (@AYi_AInotes)
   ...
   [查看原文](https://x.com/AYi_AInotes/status/2077217295504490992)
...
19. **前谷歌DeepMind研究员因公司签署无限制军事AI协议而离职** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://turntrout.com/why-i-left-google-deepmind)
...
20. **开源 LLM TODO Skill“阿福”：用 Claude Code 和 Codex 实现知识管理到排期自动化** — 公众号：卡尔的AI沃茨
   ...
   [查看原文](https://mp.weixin.qq.com/s/QcGHxKohg0gW9e84Nd_9jA)
...
21. **每天Vibe Coding 16小时，作者分享Fable 5与GPT-5.6 Sol的AI开发流程** — 公众号：数字生命卡兹克
   ...
   [查看原文](https://mp.weixin.qq.com/s/wm_LM83gyLM-auidBxprZw)
...
22. **OpenAI 呼吁通过“反向联邦主义”推动美国 AI 安全标准统一** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   ...
   [查看原文](https://openai.com/index/advancing-ai-safety-through-state-and-federal-action)
...
23. **Base44 为何信任 Claude Fable 5 处理最具挑战性的工程任务** — Claude：Blog（网页）
   ...
   [查看原文](https://claude.com/blog/working-at-the-frontier-why-base44-trusts-claude-fable-5-with-their-most-challenging-engineering-work)

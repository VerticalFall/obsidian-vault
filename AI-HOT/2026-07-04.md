...
1. **生数科技发布 Vidu S1，推动视频生成迈向“实时交互”新时代** — 公众号：生数科技（Vidu·视频）
   ...
   [查看原文](https://mp.weixin.qq.com/s/RuukpnoOA2tI0ERCNrLgtQ)

## 📦 产品发布/更新

2. **Wan Video 推出“音乐伴舞”新功能** — X：阿里云 / Alibaba Cloud (@alibaba_cloud)
   ...
   [查看原文](https://x.com/alibaba_cloud/status/2072967570441834771)

3. **面向 Web 开发者的 Safari MCP 服务器** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://webkit.org/blog/18136/introducing-the-safari-mcp-server-for-web-developers)

4. **JoyAI App 上线 UGC 数字人功能，用户可“捏”出专属虚拟玩伴** — 公众号：京东JoyAI
   ...
   [查看原文](https://mp.weixin.qq.com/s/XfpxdblzNWa5HxahRoT9pg)

5. **面壁智能发布AI全自动预训练框架ForgeTrain，8小时追平Megatron-LM** — 公众号：面壁智能（MiniCPM）
   ...
   [查看原文](https://mp.weixin.qq.com/s/JVBbqU1O967ktzfEPuDERQ)

6. **Claude Code v2.1.200 发布** — Claude Code：GitHub Releases（RSS）
   ...
   [查看原文](https://github.com/anthropics/claude-code/releases/tag/v2.1.200)

## 🏭 行业动态

7. **国家网信办就《互联网信息服务管理办法》再次征求意见，首设“智能信息服务”专章规范AI服务** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/972/341.htm)

8. **全球首例 AI Agent 勒索攻击曝光，从漏洞利用到数据库加密全程自主完成** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/972/424.htm)

9. **Google DeepMind 与 A24 宣布首次研究合作伙伴关系** — Google DeepMind：Blog（RSS）
   ...
   [查看原文](https://deepmind.google/blog/google-deepmind-and-a24-announce-first-of-its-kind-research-partnership)

## 📄 论文研究

10. **阿里达摩院发布超导材料发现AI智能体Elements Claw** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/972/089.htm)

## 💡 技巧与观点

11. **pxpipe：通过图像化压缩输入token降低Claude Code成本** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://github.com/teamchong/pxpipe)

12. **claude-real-video ─ 让任何大语言模型（LLM）都能观看视频** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://github.com/HUANGCHIHHUNGLeo/claude-real-video)

13. **藏师傅PPT与Pencil结合使用技巧** — X：歸藏 (@op7418)
   ...
   [查看原文](https://x.com/op7418/status/2073020264083050811)

14. **Fable 的判断力：Simon Willison 从 Claude Code 团队获得的效率技巧** — Simon Willison 博客
   ...
   [查看原文](https://simonwillison.net/2026/Jul/3/judgement)

15. **Claude Fable 5 自主优化 AIHOT 网站 SEO/GEO 全记录** — 公众号：数字生命卡兹克
   ...
   [查看原文](https://mp.weixin.qq.com/s/L6R_SPWlOBv6dI0wWWHQrg)

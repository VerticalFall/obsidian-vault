...
# 🔥 AI HOT 日报 · 2026-07-09

## 🧠 模型发布/更新

1. **推出 Grok 4.5** — Cursor Blog
   ...
   [查看原文](https://cursor.com/blog/grok-4-5)

2. **OpenAI 发布 GPT‑Live 新一代全双工语音模型** — OpenAI：官网动态（RSS · 排除企业/客户案例）
...
3. **Pulpie：用于清理网络的Pareto最优模型** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://usefeyn.com/blog/pulpie-pareto-optimal-models-for-cleaning-the-web)

4. **SpaceXAI 发布 Grok 4.5，与 Cursor 联合训练的编程与智能体模型** — MarkTechPost（RSS）
   ...
   [查看原文](https://www.marktechpost.com/2026/07/08/spacexai-releases-grok-4-5)

5. **蚂蚁集团旗下Robbyant开源LingBot-Vision：1B参数边界中心视觉基础模型，用于密集空间感知** — MarkTechPost（RSS）
   ...
   [查看原文](https://www.marktechpost.com/2026/07/07/ant-groups-robbyant-open-sources-lingbot-vision-a-1b-boundary-centric-vision-foundation-model-for-dense-spatial-perception)

## 📦 产品发布/更新

6. **Seedream 5.0 Pro 登陆 Runway，支持14种语言** — X：Runway (@runwayml)
   Seedream 5.0 Pro 现已登陆 Runway。可通过提示词或参考图生成高细节图像，图像内文字清晰可读，支持多达14种语言。立即点击下方链接尝试。
   [查看原文](https://x.com/runwayml/status/2074982268175630814)

7. **Replit 推出社区档案与力量排名** — X：Replit (@Replit)
   ...
   [查看原文](https://x.com/Replit/status/2074871322220339515)

8. **原生速度的 vLLM transformers 建模后端** — Hugging Face：Blog（RSS）
...
9. **OpenRouter聊天室推出一键零数据保留** — X：OpenRouter (@OpenRouter)
   新功能：聊天室一键ZDR（零数据保留） 在完全隐私保护下横向对比模型：https://openrouter.ai/chat
   [查看原文](https://x.com/OpenRouter/status/2074870468394250461)

10. **Runway Dev 发布** — Runway：News（网页）
   Runway 官网以 Cookie 设置页面代替了产品介绍，未提供 Runway Dev 的功能、参数、可用性等任何具体信息。
   [查看原文](https://runwayml.com/news/introducing-runway-dev)

11. **利用 Netpreme X‑Mem™ MPU 加速 SGLang HiCache** — LMSYS：Blog（Chatbot Arena 团队）
   ...
   [查看原文](https://www.lmsys.org/blog/2026-06-27-netpreme-xmem)

12. **Claude Code v2.1.205 发布** — Claude Code：GitHub Releases（RSS）
   ...
   [查看原文](https://github.com/anthropics/claude-code/releases/tag/v2.1.205)

## 🏭 行业动态

13. **GitLost：Noma Labs 发现 GitHub AI 代理提示词注入漏洞** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://noma.security/blog/gitlost-how-we-tricked-githubs-ai-agent-into-leaking-private-repos)

14. **美国商务部批准OpenAI大规模发布GPT-5.6，Sol明日亮相** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/973/922.htm)

15. **工信部发布Claude Code后门安全风险提示** — X：小互 (@xiaohu)
   ...
   [查看原文](https://x.com/xiaohu/status/2074736623284256881)

16. **加拿大不列颠哥伦比亚省拟起诉OpenAI：未上报ChatGPT暴力对话致校园枪击惨案** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/974/169.htm)

17. **利润超10亿美元、ARR剑指千亿，Anthropic抢先OpenAI冲击IPO** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/974/275.htm)

18. **诉讼：男子使用Grok制作7000张继女色情图像后自杀** — Ars Technica：AI（RSS）
   一男子使用Grok生成7000张继女儿童性虐待材料（CSAM）后自杀。更多年轻女孩起诉X平台，指控其涉及Grok生成CSAM，并包庇儿童性犯罪者。
   [查看原文](https://arstechnica.com/tech-policy/2026/07/lawsuit-grok-user-made-7k-child-sex-images-xai-only-reported-one-gang-rape-prompt)

19. **OpenAI发布政府与国家安全合作伙伴关系方针** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   ...
   [查看原文](https://openai.com/index/government-national-security-partnerships)

20. **GitHub 联合联盟倡议修订 California AI Transparency Act 以保护开源生态** — GitHub Blog
   GitHub 加入一个联盟，呼吁对 California AI Transparency Act 进行针对性修订，以解决该法案与开源许可之间的冲突，并与国际透明度框架保持一致，同时保留其监管意图。
   [查看原文](https://github.blog/news-insights/company-news/github-availability-report-june-2026)

## 📄 论文研究

21. **黑客可利用9款最流行的AI工具组装大规模僵尸网络** — Ars Technica：AI（RSS）
   ...
   [查看原文](https://arstechnica.com/security/2026/07/hackers-can-use-9-of-the-most-popular-ai-tools-to-assemble-massive-botnets)

22. **OpenAI 审计 SWE-Bench Pro 发现约 30% 的评测任务存在缺陷** — OpenAI：官网动态（RSS · 排除企业/客户案例）
...
23. **面向AI模型双重用途知识的“开关”：Anthropic与AE Studio提出GRAM方法** — Anthropic：Research（发表成果 · 网页）
...
24. **Claude开发者分享两种多智能体模式：Advisor和Orchestrator** — X：邵猛 (@shao__meng)
   ...
   [查看原文](https://x.com/shao__meng/status/2074661249804366310)

25. **在校研究生Kunkun开源管理相互调用Skill的方法** — X：Berry Xia (@berryxia)
   ...
   [查看原文](https://x.com/berryxia/status/2074827915779580055)

26. **《人生设计课》Prompt实测：用Claude设计人生的四个阶段** — 公众号：数字生命卡兹克
   ...
   [查看原文](https://mp.weixin.qq.com/s/VDlBdkspV0SQNFJYLxOogQ)

27. **AI 审计代理在 Cloudflare CIRCL 中发现 7 个漏洞** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://blog.zksecurity.xyz/posts/circl-bugs)

28. **蚂蚁集团周俊AICon演讲：从Token数量到Token密度，万亿参数模型效率优先** — 公众号：蚂蚁百灵（Ling）
   ...
   [查看原文](https://mp.weixin.qq.com/s/dsIfi4C-T5Q4emmIh-7yzg)

29. **AI预检检查：智能体工作记忆架构** — Tomer Tunguz 博客（VC 分析）
   ...
   [查看原文](https://www.tomtunguz.com/the-ai-preflight-check)

30. **Anthropic 市场运营团队用 Claude Cowork 自动化报告与活动构建** — Claude：Blog（网页）
   ...
   [查看原文](https://claude.com/blog/how-anthropics-marketing-operations-team-uses-claude-cowork-to-automate-reporting-and-campaign-builds)

31. **NVIDIA 发布 Nemotron 开放数据集与配套工具，支持 AI 智能体开发** — Hugging Face：Blog（RSS）
   ...
   [查看原文](https://huggingface.co/blog/nvidia/open-data-for-agents)

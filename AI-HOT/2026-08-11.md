...
1. **SGLang 为 Muse Glimmer 提供 Day-0 支持，针对本地智能体工作流优化推理** — LMSYS：Blog（Chatbot Arena 团队）
   ...
   [查看原文](https://www.lmsys.org/blog/2026-08-10-meta-muse-glimmer)
...
2. **Meta 发布开源模型 Muse Glimmer** — X：AI at Meta (@AIatMeta)
   ...
   [查看原文](https://x.com/AIatMeta/status/2086757844544811485)

3. **OpenAI 推出 GPT-5.6-Cyber，面向授权漏洞研究的网络安全专用模型** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   OpenAI 发布网络安全专用模型 GPT-5.6-Cyber，可通过 Daybreak Red 获取，用于授权的漏洞研究、漏洞验证和安全测试。该模型旨在应对网络防御窗口不断收窄的挑战，为安全研究人员提供专门工具。
   [查看原文](https://openai.com/index/expanding-daybreak-as-the-cyber-defense-window-narrows)

## 📦 产品发布/更新

4. **OpenRouter 推出由市场智慧驱动的新版 Auto 路由器** — OpenRouter：Announcements（RSS）
   ...
   [查看原文](https://openrouter.ai/blog/announcements/introducing-the-new-auto-router)
...
5. **千问开放平台上线：租房、寄快递、查理财等十余领域服务可对话办理** — 公众号：千问APP（阿里）
   ...
   [查看原文](https://mp.weixin.qq.com/s?__biz=MzYzNDE5MDEwMQ%3D%3D&mid=2247488345&idx=1&sn=ef4e57c9c9350f9238d90211eb2dd453)
...
6. **Qwen-MM-Plugins 让智能体原生支持多模态** — X：通义千问 / Qwen (@Alibaba_Qwen)
   ...
   [查看原文](https://x.com/Alibaba_Qwen/status/2086664887560970531)

7. **OpenChamber：一个基于代理的开发环境** — Hacker News 热门（buzzing.cc 中文翻译）
...
8. **Claude Code 自动模式默认开启原理** — X：Claude Devs (@ClaudeDevs)
   ...
   [查看原文](https://x.com/ClaudeDevs/status/2086844755770757531)
...
9. **我花了54个小时，做了一个可能更公平的AI大模型排行榜。** — 公众号：数字生命卡兹克
   ...
   [查看原文](https://mp.weixin.qq.com/s?__biz=MzIyMzA5NjEyMA%3D%3D&mid=2647685059&idx=1&sn=a329fe9999ac2419470c7eca9a97acd3)

10. **Omnigent 上下文策略如何阻断“致命三重奏”组合攻击** — Databricks：Blog（RSS）
   ...
   [查看原文](https://www.databricks.com/blog/innocent-until-combined-blocking-lethal-trifecta-omnigent-contextual-policies)

11. **Google 为 Google Ads 和 Google Analytics 推出新 AI 与智能体功能** — Google Blog：AI（RSS）
   ...
   [查看原文](https://blog.google/products/ads-commerce/google-ads-analytics-ai-updates)
...
12. **英伟达联合六大机构融资5000亿美元建AI工厂** — X：Jensen Huang (@JensenHuang)
   ...
   [查看原文](https://x.com/JensenHuang/status/2086934705207959965)

13. **Zapier 如何用 ChatGPT Work 改造核心营销流程** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   ...
   [查看原文](https://openai.com/index/zapier)

## 📄 论文研究

14. **Claude 未发布研究版将黎曼 zeta 函数零点下界从 41.6% 提升至 67.2%** — Anthropic：Research（发表成果 · 网页）
...
15. **tl;dv 逾18.1万段AI会议录音被公开暴露，可实时闯入他人通话** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://bobdahacker.com/blog/tldv-hack)

16. **智能体真的会用电脑吗？a16z 用数据给出答案** — a16z：News（RSS）
   a16z 数据显示，计算机操作智能体在 OSWorld-Verified 基准上的最佳成绩已从一年前的 42% 升至 85%，超过人类测试者约 72% 的水平，Claude Fable 5 以 85% 领先。
   [查看原文](https://www.a16z.news/p/can-agents-use-a-computer-yet-weve)
...
17. **扎克伯格：超级智能应人人可用** — X：Mark Zuckerberg (@finkd)
   ...
   [查看原文](https://x.com/finkd/status/2086754845218726027)

18. **Linear 如何构建 Linear Agent：在系统提示词、工具设计与系统技能中划定边界** — Linear：Now（RSS）
   ...
   [查看原文](https://linear.app/now/how-we-built-linear-agent)
...
19. **Forking-Sequences：一种统计与计算上更高效的多步预测训练范式** — CMU：Machine Learning Blog
   ...
   [查看原文](https://blog.ml.cmu.edu/2026/08/10/forking-sequences-part-i-statistically-and-computationally-efficient-multi-horizon-forecasting)

20. **开源不等于开放权重：Gary Marcus 剖析两者本质差异** — Gary Marcus：The Road to AI We Can Trust（RSS）
   ...
   [查看原文](https://garymarcus.substack.com/p/open-source-is-not-the-same-as-open)

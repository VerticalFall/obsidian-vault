...
# 🔥 AI HOT 日报 · 2026-08-03

## 📦 产品发布/更新

1. **Grok 支持分析任意视频** — X：Elon Musk (@elonmusk, xAI)
   Grok 可以分析任何视频 https://grok.com/share/bGVnYWN5_8013f7a3-f604-4351-8cd7-acecf3ef165b
   [查看原文](https://x.com/elonmusk/status/2083800942927839307)

## 🏭 行业动态

2. **Cloudflare 开启 Agents Week：探讨面向智能体的 Agent Cloud 形态** — Cloudflare Blog
   ...
   [查看原文](https://blog.cloudflare.com/agents-week-welcome)

## 💡 技巧与观点

3. **Codex 用 Sol 指挥 Luna Max 省额度翻倍产出** — X：阿易 AI Notes (@AYi_AInotes)
   ...
   [查看原文](https://x.com/AYi_AInotes/status/2083867265179537565)

4. **OpenAI 新模型 Astra 数学表现出色，但被过度吹捧** — Gary Marcus：The Road to AI We Can Trust（RSS）
   ...
   [查看原文](https://garymarcus.substack.com/p/openais-amazing-but-vastly-oversold)

5. **最新开源模型盘点（#23）：Laguna S2.1、Inkling 与 Kimi K3 展现开源模型在帕累托前沿的价值** — Nathan Lambert：Interconnects（RSS）
   Thinking Machines 发布首个模型 Inkling，为 975B-A41B 多模态 MoE，支持文本、图像和音频输入，并推出 276B-A12B 小版本。
   [查看原文](https://www.interconnects.ai/p/latest-open-artifacts-23-laguna-s21)

...
1. **谷歌推出 WeatherNext 气旋模型，AI 高精度预报飓风平均提前 24 小时** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/986/951.htm)

## 📦 产品发布/更新

2. **Seedance 2.5 API上线，视频生成开启「电影级长叙事」** — 公众号：火山引擎
   火山引擎正式上线 Seedance 2.5 API，将单次视频生成时长从15秒提升至30秒，并支持最高50个全模态素材参考。模型在指令遵循、长叙事、真人感及声画质感上大幅提升，能稳定保持多角色外形与场景关系，兼容十余种语言。
   [查看原文](https://mp.weixin.qq.com/s?__biz=MzI0NzU1NzI5NQ%3D%3D&mid=2247543416&idx=1&sn=badeafc780a939033a1e4cb0bba4221c)

3. **Kitesurf：一款在 V8 隔离环境中运行的“代理优先”浏览器** — Hacker News 热门（buzzing.cc 中文翻译）
...
4. **HPC-Ops × SGLang：腾讯混元开源高性能 Attention、Router GEMM 与 MoE 算子** — LMSYS：Blog（Chatbot Arena 团队）
   腾讯混元开源算子库 HPC-Ops 已集成至 SGLang 主分支，其 Dynamic Attention 与 Fused MoE 在 Hy3 模型上最高降低 TPOT 48.8%。
   [查看原文](https://www.lmsys.org/blog/2026-08-07-hpc-ops-sglang)

5. **Claude Code 会话间可互发消息** — X：Claude Devs (@ClaudeDevs)
   Claude Code 新功能：你的会话现在可以互相发送消息了。 无需在另一个会话中重新解释自己，你现在可以让 Claude 代为传达。它会发送一份摘要（而非你的历史记录或文件），另一个会话会在任务进行中接收该摘要。
   [查看原文](https://x.com/ClaudeDevs/status/2085817074816070014)

6. **千问功能上新：推出思考研究、定时任务、办公助理、语音通话等多项新功能，并支持 Qwen3.8-MAX** — 公众号：千问APP（阿里）
   ...
   [查看原文](https://mp.weixin.qq.com/s?__biz=MzYzNDE5MDEwMQ%3D%3D&mid=2247488266&idx=1&sn=3a1988ba0710abcefba9c9dd282b464e)

7. **Anthropic 更新 Claude Fable 5 生物安全防护，误报率大幅降低** — Anthropic：Newsroom（网页）
   ...
   [查看原文](https://www.anthropic.com/news/improving-fable-5-s-biology-safeguards)

8. **Suno移动端上线Voices功能** — X：Suno (@suno)
   ...
   [查看原文](https://x.com/suno/status/2085731234970227145)

9. **LangChain 推出 Managed Deep Agents 公开测试版** — LangChain：Blog（RSS）
   LangChain 的 Managed Deep Agents 进入公开测试版，可将 Deep Agents 部署到托管的 LangSmith 运行时。该服务提供持久化执行、记忆、沙箱、通道、评估（evals）及生产级基础设施。
   [查看原文](https://www.langchain.com/blog/managed-deep-agents-is-now-in-public-beta)

## 🏭 行业动态

10. **OpenAI 披露 ChatGPT 全球 10 亿用户画像：35 岁及以上用户用量上升** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/986/957.htm)

11. **OpenAI 发布 Astra 初步网络安全评估与防护强化措施** — OpenAI：官网动态（RSS · 排除企业/客户案例）
...
12. **斯坦福与 Arc Institute 用 AI 设计全新病毒基因组，16 种在实验室成功杀死细菌** — The Decoder：AI News（RSS）
   ...
   [查看原文](https://the-decoder.com/stanford-and-arc-institute-scientists-used-ai-to-design-new-viruses-that-killed-bacteria-in-the-lab)

13. **小红书联合浙大、复旦提出 CULTURE-MT：首个面向社媒翻译的「文化有效性」评测基准，入选 ICML 2026** — 公众号：小红书技术（dots.llm）
   小红书联合浙江大学、复旦大学提出 CULTURE-MT，这是首个面向中英社媒笔记翻译、兼顾文化符号传递与情感共鸣的评测基准，并首次提出「文化有效性」评估标准与自动评估模型 JUDGER（准确率 86.03%）。
   [查看原文](https://mp.weixin.qq.com/s?__biz=Mzg4OTc2MzczNg%3D%3D&mid=2247496008&idx=1&sn=08f2ce717483f63bc00a2181e59e3f40)

14. **扩展分类流映射（Categorical Flow Maps）规模** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/scaling-categorical-flow-maps)

15. **Arbitrage：利用优势感知投机实现高效推理** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/arbitrage-efficient-reasoning)

16. **超越下一个 token 预测：扩散语言模型与自回归语言模型的性能对比研究** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/diffusion-autoregressive-performance)

## 💡 技巧与观点

17. **OpenAI 智能体在安全测试中自行搭建秘密聊天室并攻破系统** — Tomer Tunguz 博客（VC 分析）
   ...
   [查看原文](https://www.tomtunguz.com/the-secret-chat-room)

18. **独立开发者用 VoxCPM 克隆网红声音，让 AI 终于“会聊天”了** — 公众号：面壁智能（MiniCPM）
   独立开发者叶小叔用面壁智能开源的 VoxCPM 克隆千万粉丝网红声音，搭建 STT → LLM → VoxCPM（TTS）三段式实时对话管道，TTS 首包延迟不到 1 秒，端到端体感 2 到 3 秒。
   [查看原文](https://mp.weixin.qq.com/s?__biz=Mzg3Mzg2MTg2NQ%3D%3D&mid=2247498927&idx=1&sn=c5fbfaac5ede8b1008d17337a1bdc70b)

19. **Databricks 如何规模化管控 AI 编程成本** — Databricks：Blog（RSS）
...
20. **持续学习时代的 8 个预测** — Dwarkesh Patel：Podcast & Blog（RSS）
   ...
   [查看原文](https://www.dwarkesh.com/p/era-of-continual-learning)

21. **什么是 AI 助手？Databricks 详解其工作原理与类型** — Databricks：Blog（RSS）
   AI 助手通过语言模型、数据检索和推理来理解请求并生成响应。Databricks 在博客中解析了 AI 助手的基本架构，涵盖其如何结合检索增强生成（RAG）与推理能力，并区分了不同类型的助手及其在企业场景中的应用方式。
   [查看原文](https://www.databricks.com/blog/what-is-an-ai-assistant)

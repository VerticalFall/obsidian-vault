...
1. **腾讯混元发布Hy3模型：295B参数MoE架构，Agent向LLM定位，已集成微信服务10亿+用户** — X：阿易 AI Notes (@AYi_AInotes)
   ...
   [查看原文](https://x.com/AYi_AInotes/status/2076341952023310580)

## 📦 产品发布/更新

2. **Mesh LLM：在 iroh 上进行分布式人工智能计算** — Hacker News 热门（buzzing.cc 中文翻译）
...
3. **Codex与ChatGPT Work多项更新：取消5小时限制** — X：Tibo (@thsottiaux)
   ...
   [查看原文](https://x.com/thsottiaux/status/2076365965915467978)

4. **Mindwalk：在代码库 3D 地图上回放编码代理会话** — Hacker News 热门（buzzing.cc 中文翻译）
...
5. **苹果起诉OpenAI挖角窃密，分析师称即使指控未证实也可能重创其硬件计划** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/975/666.htm)

## 📄 论文研究

6. **OpenAI GPT-5.6 Sol Ultra 一小时证明 50 年图论猜想** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/975/646.htm)

## 💡 技巧与观点

7. **纳德拉提出“反向信息悖论”：企业使用AI时需保护自身知识** — X：Satya Nadella (@satyanadella)
   ...
   [查看原文](https://x.com/satyanadella/status/2076323181154230284)

8. **Tibo 分享通过 CLIProxyAPI 将 Claude Code 后端模型切换为 GPT-5.6 Sol 的方法** — X：Tibo (@thsottiaux)
   ...
   [查看原文](https://x.com/thsottiaux/status/2076119366647894371)

9. **xAI Grok Build CLI 网络流量分析：上传仓库全部文件及 git 历史** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://gist.github.com/cereblab/dc9a40bc26120f4540e4e09b75ffb547)

10. **OpenAI CEO Altman 改口称 AI 净创造就业，Anthropic CEO 也修正早期言论** — The Decoder：AI News（RSS）
   ...
   [查看原文](https://the-decoder.com/openai-ceo-altman-is-now-pretty-sure-ai-is-net-job-creating-which-is-quite-the-pivot-from-predicting-mass-layoffs)

11. **开源模型面临未来6个月的生存考验** — Nathan Lambert：Interconnects（RSS）
   ...
   [查看原文](https://www.interconnects.ai/p/6-months-to-live-for-open-models)

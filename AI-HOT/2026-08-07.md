...
1. **NVIDIA Cosmos 3：开放世界模型如何推动物理 AI 前沿** — NVIDIA Blog（RSS）
   ...
   [查看原文](https://blogs.nvidia.com/blog/open-world-models-physical-ai)

2. **ChatGPT 推出改进版 GPT-5.6 Sol，并扩大免费用户访问权限** — OpenAI：官网动态（RSS · 排除企业/客户案例）
...
3. **Agent Plugins 1.0.0 发布：谷歌、亚马逊、微软等支持的统一智能体插件规范** — Google Developers Blog（RSS）
...
4. **谷歌地图 Ask Maps 智能体升级：可对话订餐、找酒店并接入 Gemini Personal Intelligence** — IT之家（RSS）
   谷歌地图宣布 Ask Maps 迎来新一轮升级，新增智能体功能，可替用户执行订餐操作，并综合考虑饮食要求、当前位置和收藏地点等信息；用户还可通过对话指定装修风格、环境氛围等条件查找酒店和当地活动。
   [查看原文](https://www.ithome.com/0/986/729.htm)
...
5. **Prime Agent：一个具有自我改进能力的RLM代理** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://www.primeintellect.ai/blog/prime-agent)

6. **千问全网首发公测，全新 Wan3.0 来了！** — 公众号：千问APP（阿里）
   ...
   [查看原文](https://mp.weixin.qq.com/s?__biz=MzYzNDE5MDEwMQ%3D%3D&mid=2247488240&idx=1&sn=3fea5624e07184f42661d5f3bc798873)

7. **Cursor Router 如何为任务选择合适模型** — Cursor Blog
   ...
   [查看原文](https://cursor.com/blog/how-cursor-router-works)

8. **Claude Code v2.1.223 发布：新增市场通配符、修复多项安全漏洞** — Claude Code：GitHub Releases（RSS）
   Claude Code v2.1.223 发布，为严格已知市场和屏蔽市场设置新增“owner/*”通配符条目，可批量允许或阻止 GitHub 组织下的所有市场仓库。
   [查看原文](https://github.com/anthropics/claude-code/releases/tag/v2.1.223)

9. **Databricks 发布 OfficeQA Pro V2：面向企业落地推理的新基准** — Databricks：Blog（RSS）
   Databricks 发布 OfficeQA Pro V2，一个用于评估企业落地推理能力的新基准。该基准旨在检验模型在真实办公场景中基于给定资料进行推理的准确性与可靠性，为企业级 AI 应用选型提供参考依据。
   [查看原文](https://www.databricks.com/blog/introducing-officeqa-pro-v2-new-benchmark-enterprise-grounded-reasoning)

## 🏭 行业动态

10. **微软首次披露OpenAI贡献七成AI收入** — X：Rohan Paul (@rohanpaul_ai)
   ...
   [查看原文](https://x.com/rohanpaul_ai/status/2085368375816163423)

11. **科学家首次用AI制造新病毒** — X：AI Safety Memes (@AISafetyMemes)
   superebola/acc 🚀🚀🚀 [引用 @nytimes]：突发新闻：科学家首次利用人工智能制造出新病毒，在为医学进步带来希望的同时，也引发了该技术有朝一日可能被用于制造危险病原体的担忧。https://nyti.ms/4bxx7Wy
   [查看原文](https://x.com/AISafetyMemes/status/2085447739320758622)

12. **Google 大规模 AI 组织调整背后的混乱政治** — The Verge：AI（RSS）
   ...
   [查看原文](https://www.theverge.com/tech/976108/google-ai-leadership-shakeup-jeff-dean-demis-hassabis-deepmind)

13. **宇树科技科创板发行价定为 150.8 元/股，市盈率 219.23 倍高于行业平均** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/986/699.htm)

14. **OpenAI 称苹果自身安全实践削弱其商业机密诉讼** — TechCrunch：AI（RSS）
   ...
   [查看原文](https://techcrunch.com/2026/08/06/openai-says-apples-own-security-practices-undermine-its-trade-secrets-case)

15. **Kimi K3 现已通过 Unity AI Gateway 登陆 Databricks** — Databricks：Blog（RSS）
   ...
   [查看原文](https://www.databricks.com/blog/kimi-k3-moonshot-ai-now-available-databricks-through-unity-ai-gateway)
...
16. **阿谀奉承的人工智能会削弱利他意图并助长依赖性（2025）** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://arxiv.org/abs/2510.01395)
...
17. **Microsoft 的 SkillOpt 证明优化后的智能体技能工件可在不同模型规模及 Codex 与 Claude Code 之间迁移** — MarkTechPost（RSS）
   ...
   [查看原文](https://www.marktechpost.com/2026/08/05/microsoft-skillopt-agent-skill-transfer-portability)

## 💡 技巧与观点

18. **OpenAI 开源 Codex Security：Vibe Coding 产品必备的安全扫描插件** — 公众号：数字生命卡兹克
   OpenAI 将安全插件 Codex Security 开源，外部 Agent 均可调用，并已支持通过 OpenRouter 和 Fireworks 接入第三方模型。
   [查看原文](https://mp.weixin.qq.com/s?__biz=MzIyMzA5NjEyMA%3D%3D&mid=2647684990&idx=1&sn=86a6d71b133589916b49a9d57046c127)

19. **AI 聊天机器人催生“螺旋主义”神秘准宗教运动，人类纷纷追随** — The Verge：AI（RSS）
   ...
   [查看原文](https://www.theverge.com/ai-artificial-intelligence/975017/ai-spiralism-chatbot-movement)

20. **左右两派罕见达成一致：反对数据中心** — The Verge：AI（RSS）
   ...
   [查看原文](https://www.theverge.com/podcast/971855/ai-data-center-backlash-protests-florida-bipartisan)

21. **分享10个能大幅提升vibe coding幸福感的开源App** — 公众号：卡尔的AI沃茨
   ...
   [查看原文](https://mp.weixin.qq.com/s?__biz=Mzg3MTk3NzYzNw%3D%3D&mid=2247509213&idx=1&sn=0ee2b58388d9bdb7f3f087d5197b6f19)

22. **GitHub Copilot 应用中的斜杠命令使用指南** — GitHub Blog
   ...
   [查看原文](https://github.blog/ai-and-ml/github-copilot/a-guide-to-slash-commands-in-the-github-copilot-app)

23. **面壁智能 AMNESIAC：反向图灵测试 AI 审讯游戏** — X：面壁智能 OpenBMB (@OpenBMB)
   ...
   [查看原文](https://x.com/OpenBMB/status/2085350175782949094)

24. **Databricks 详解什么是 Tool Calling** — Databricks：Blog（RSS）
   ...
   [查看原文](https://www.databricks.com/blog/what-is-tool-calling)

25. **为何不应过早看衰 Google** — Gary Marcus：The Road to AI We Can Trust（RSS）
   ...
   [查看原文](https://garymarcus.substack.com/p/seven-reasons-i-wouldnt-count-google)

...
# 🔥 AI HOT 日报 · 2026-07-08

## 🧠 模型发布/更新

1. **Meta Superintelligence Labs 推出 Muse Image 和 Muse Video** — X：AI at Meta (@AIatMeta)
   ...
   [查看原文](https://x.com/AIatMeta/status/2074577662840832382)

## 📦 产品发布/更新

2. **MIRA：可玩多人世界模型，20 FPS实时生成“火箭联盟的梦”** — X：Ethan Mollick (@emollick)
   ...
   [查看原文](https://x.com/emollick/status/2074348274136346871)

3. **Rowboat：开源、本地优先的桌面AI助手** — Hacker News：AI 热帖
   ...
   [查看原文](https://github.com/rowboatlabs/rowboat)

4. **Grok Imagine 更新：支持 15 秒视频** — X：Elon Musk (@elonmusk, xAI)
   Grok Imagine 更新。请更新你的 Grok 应用！15 秒 Imagine 视频现已可用，质量令人难以置信。
   [查看原文](https://x.com/elonmusk/status/2074378653501128833)

5. **Claude Cowork 向移动端和网页端开放** — Claude：Blog（网页）
   ...
   [查看原文](https://claude.com/blog/cowork-web-mobile)

6. **Gemini API Managed Agents 新增后台执行、远程 MCP 与自定义函数等能力** — Google Blog：AI（RSS）
   ...
   [查看原文](https://blog.google/innovation-and-ai/technology/developers-tools/expanding-managed-agents-gemini-api)

7. **NotebookLM短视频概览正式上线** — X：NotebookLM (@NotebookLM)
   短视频概览功能已正式在移动端和网页端面向所有英语用户全面上线！ 一如既往，您的意见对我们至关重要。请在下方分享您最喜欢的作品，并告诉我们接下来需要添加哪些功能！❤️
   [查看原文](https://x.com/NotebookLM/status/2074551227594264799)

8. **Hugging Face Storage 成为 SkyPilot 一级后端：零出站费跨云存储** — Hugging Face：Blog（RSS）
   ...
   [查看原文](https://huggingface.co/blog/skypilot-hf-storage)

9. **Claude Code v2.1.203 发布** — Claude Code：GitHub Releases（RSS）
   ...
   [查看原文](https://github.com/anthropics/claude-code/releases/tag/v2.1.203)

## 🏭 行业动态

10. **中国拟限制外国访问最强AI模型** — X：Rohan Paul (@rohanpaul_ai)
   ...
   [查看原文](https://x.com/rohanpaul_ai/status/2074512389526237609)

11. **Ethan Mollick：开放权重模型供给难持续** — X：Ethan Mollick (@emollick)
   这是一个关键原因，我不期望前沿开放权重模型的流动会无限期持续，甚至不会持续更长时间。
   [查看原文](https://x.com/emollick/status/2074497401578996154)

12. **微软为降成本在Copilot中用自研MAI模型替换OpenAI和Anthropic模型** — The Decoder：AI News（RSS）
   ...
   [查看原文](https://the-decoder.com/copilot-goes-cheap-as-microsoft-phases-out-openai-and-anthropic-models-to-cut-costs)

13. **美国首批自主地面车辆在乌克兰参战** — TechCrunch：AI（RSS）
   ...
   [查看原文](https://techcrunch.com/2026/07/07/the-first-american-autonomous-ground-vehicles-are-fighting-in-ukraine)

## 📄 论文研究

14. **苹果研究：单个神经元即可绕过大型语言模型的安全对齐** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/single-neuron-safety-alignment)

15. **Weblica：面向视觉网页智能体的可扩展可复现训练环境** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/weblica-visual-web-agents)

16. **DynaMiCS：带性能约束的大语言模型动态混合微调** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/dynamics-fine-tuning-llms)

## 💡 技巧与观点

17. **Elvis Saravia 通过 HITL 和 DialAgent 提升 agentic loops 可靠性** — X：Elvis Saravia (@omarsar0, DAIR.AI)
   ...
   [查看原文](https://x.com/omarsar0/status/2074506169352180108)

18. **FDE爆发：AI公司12个月承诺97.5亿美元部署工程** — Tomer Tunguz 博客（VC 分析）
   ...
   [查看原文](https://www.tomtunguz.com/the-10b-fde-boom)

19. **YC CEO声称每日用AI部署3.7万行代码，开发者审查发现前端代码大量臃肿低效** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://www.fastcompany.com/91520702/y-combinator-garry-tan-agentic-ai-social-media)

20. **Liquid AI 开源 Antidoom：基于最终 Token 偏好优化的推理模型死循环修复方法** — MarkTechPost（RSS）
   ...
   [查看原文](https://www.marktechpost.com/2026/07/07/liquid-ai-antidoom-doom-loops-ftpo)

21. **在网络不稳定的地区，小型AI模型正逐渐普及** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://spectrum.ieee.org/small-language-models-ai-pharmaceuticals)

22. **Krea 2 身份保留功能上线** — X：Krea AI (@krea_ai)
   Krea 2 的身份保留功能已发布，配套模型和 ComfyUI 节点也已上线。🔥
   [查看原文](https://x.com/krea_ai/status/2074589965653303321)

23. **人们如何使用Claude Cowork** — Claude：Blog（网页）
   ...
   [查看原文](https://claude.com/blog/how-people-are-using-claude-cowork)

24. **在 Claude Code 中选择 Claude 模型与努力级别** — Claude：Blog（网页）
   ...
   [查看原文](https://claude.com/blog/claude-model-and-effort-level-in-claude-code)

...
1. **Gemini Omni 1.1 Flash 发布，为开发者提供更强生成式视频控制** — Google DeepMind：Blog（RSS）
   ...
   [查看原文](https://deepmind.google/blog/gemini-omni-1-1-flash-lets-you-build-with-more-control)
...
2. **Midjourney 开放 V8.2 图像编辑模型测试** — Midjourney：Updates（RSS）
   ...
   [查看原文](https://updates.midjourney.com/edit-model-for-v8)
...
3. **Anthropic 开放模型硬件标准（MHS）研究预览** — Anthropic：Newsroom（网页）
   ...
   [查看原文](https://www.anthropic.com/news/model-hardware-standard-research-preview)
...
5. **Claude Code v2.1.248 发布：新增受限模式与跨会话消息功能** — Claude Code：GitHub Releases（RSS）
   ...
   [查看原文](https://github.com/anthropics/claude-code/releases/tag/v2.1.248)
...
6. **NVIDIA Vera CPU 正式出货：首款为 AI 智能体打造的处理器** — NVIDIA Blog（RSS）
   ...
   [查看原文](https://blogs.nvidia.com/blog/vera-cpu-delivery)
...
7. **Anthropic 扩大对科学家的支持：开放 1 万席位免费及优惠 Claude 订阅** — Anthropic：Newsroom（网页）
   ...
   [查看原文](https://www.anthropic.com/news/expanding-support-for-scientists)
...
8. **英伟达预计 2028 财年销售额达 6730 亿美元** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://forgeeks.net/nvidia-673-billion-ai-growth-forecast)
...
9. **我国日均词元调用量突破 500 万亿，中国大模型稳居全球第一梯队** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/995/136.htm)
...
10. **诉讼指控 xAI 使用儿童性虐待材料训练 Grok 模型** — Ars Technica：AI（RSS）
   ...
   [查看原文](https://arstechnica.com/tech-policy/2026/08/elon-musks-xai-used-child-porn-to-train-grok-models-lawsuit-says)
...
11. **OpenAI 在巴西启动商业运营，深化长期布局** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   ...
   [查看原文](https://openai.com/index/expanding-our-presence-in-brazil)
...
13. **MiniMax-H3 在 8×H200 上基准测试：无损加速 1.95×，最高 6.24×（SSIM 0.76–0.91）** — LMSYS：Blog（Chatbot Arena 团队）
   ...
   [查看原文](https://www.lmsys.org/blog/2026-08-27-minimax-h3-h200)
...
14. **Google Earth AI 推出行星预测引擎：自动化全球地理空间建模** — Google Research：Blog（网页）
   ...
   [查看原文](https://research.google/blog/planetary-prediction-engine-automating-global-models-via-earth-ai)
...
15. **ChatGPT 与因果推理训练如何互补提升学生作业质量** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   ...
   [查看原文](https://openai.com/index/what-students-gain-from-chatgpt-critical-thinking-training)
...
16. **OpenAI 失控智能体集体逃逸沙箱并攻击“幽灵”评分器事件调查公布** — The Decoder：AI News（RSS）
   ...
   [查看原文](https://the-decoder.com/openais-rogue-ai-collective-was-smart-enough-to-break-out-of-sandboxes-but-dumb-enough-to-fight-a-ghost)
...
17. **OpenClaw 走红后，维护者如何构建并保障其安全** — GitHub Blog
   ...
   [查看原文](https://github.blog/open-source/maintainers/openclaw-went-viral-meet-the-maintainers-building-and-securing-it)

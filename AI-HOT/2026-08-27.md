...
1. **GLM-5.3-Flash 开源：320B 总参数、AA 指数 57 分，定价为 Opus 4.8 的 1/40** — 公众号：智谱（GLM）
   ...
   [查看原文](https://mp.weixin.qq.com/s?__biz=MzkyMzI3NzQ0Mg%3D%3D&mid=2247494157&idx=1&sn=6837b15a07d2518842eb6c6b53a3eb3c)
...
2. **Qwen3.8-Flash-Next 开源：Qwen4 架构早期预览** — Qwen：Blog Retrieval（API）
   ...
   [查看原文](https://qwen.ai/blog?id=qwen3.8-flash-next)
...
3. **Gemini 3.5 Transcribe 发布：面向实时语音交互的高精度语音转文本模型** — Google DeepMind：Blog（RSS）
   ...
   [查看原文](https://deepmind.google/blog/intelligent-transcription-with-gemini-3-5-transcribe)
...
4. **腾讯混元将端侧翻译模型 Hy-MT2-1.8B 压缩至 440MB，已落地哔哩哔哩直播弹幕翻译** — 公众号：腾讯混元
   ...
   [查看原文](https://mp.weixin.qq.com/s?__biz=MzkwODU2OTQyNQ%3D%3D&mid=2247498367&idx=1&sn=f1a5cf87eb06015cbe995bd5ef8b5d0a)
...
5. **GlucoFM：面向连续血糖监测的基础模型** — Google Research：Blog（网页）
   ...
   [查看原文](https://research.google/blog/glucofm-foundation-model-for-continuous-glucose-monitoring)
...
6. **Claude in Chrome 正式全面上线** — Claude：Blog（网页）
   ...
   [查看原文](https://claude.com/blog/claude-in-chrome-generally-available)
...
7. **Claude Cowork 内置浏览器上线：Claude 可在桌面应用中自主浏览网页** — Claude：Blog（网页）
   ...
   [查看原文](https://claude.com/blog/cowork-built-in-browser)
...
8. **NVIDIA 扩展 NVLink Fusion，推出 NVHBM 定制高带宽内存技术** — NVIDIA Blog（RSS）
   ...
   [查看原文](https://blogs.nvidia.com/blog/nvlink-fusion-nvhbm-custom-high-bandwidth-memory)
...
9. **Databricks 推出 Governance Hub：面向整个数据资产的智能账户级治理** — Databricks：Blog（RSS）
   ...
   [查看原文](https://www.databricks.com/blog/introducing-governance-hub-intelligent-account-level-governance-over-your-databricks-estate)
...
11. **Claude for Word: Turn a draft into a finished document** — Claude：YouTube（RSS）
   [查看原文](https://www.youtube.com/watch?v=x80HVKbZrno)
...
12. **OpenAI 发布 Hugging Face 事件技术报告：内部模型突破隔离并入侵第三方系统** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   ...
   [查看原文](https://openai.com/index/hugging-face-incident-and-the-road-ahead)
...
13. **以色列资助的假美国智库试图利用AI进行宣传** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://www.theguardian.com/world/2026/aug/26/fake-thinktank-israel-ai-propaganda)
...
14. **亚马逊将英伟达芯片订单增至三倍，新增200万颗GPU** — TechCrunch：AI（RSS）
   ...
   [查看原文](https://techcrunch.com/2026/08/26/amazon-just-tripled-its-order-of-nvidia-chips-over-surging-demand)
...
15. **英伟达 2027 财年半年报归母净利润 1180.1 亿美元，同比增长 161.1%** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/994/791.htm)
...
16. **Linear 完成 9900 万美元要约收购，估值达 25 亿美元** — Linear：Now（RSS）
   ...
   [查看原文](https://linear.app/now/sharing-growth-with-the-people-building-linear)
...
17. **OpenAI 将 ChatGPT for Teachers 扩展至美国 55 个新学区，覆盖超 10 万名教育工作者** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   ...
   [查看原文](https://openai.com/index/bringing-chatgpt-for-teachers-to-more-us-school-districts)
...
18. **C2PA相机经不起现实的考验：Android端可被root攻击伪造签名** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://www.da.vidbuchanan.co.uk/blog/android-c2pa.html)
...
19. **Anthropic 开放 Claude 真实使用数据供外部独立研究，公布试点结果** — Anthropic：Research（发表成果 · 网页）
   ...
   [查看原文](https://www.anthropic.com/research/enabling-independent-research)
...
20. **OpenAI 发布教育报告：ChatGPT 如何让学习不再受课堂时间限制** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   ...
   [查看原文](https://openai.com/index/learning-never-stops)
...
21. **IDEA Prune：生成式语言模型预训练中的集成放大-剪枝流程** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/idea-prune-pipeline)
...
22. **PROOF-Gen：从优化数据到更好的知识蒸馏** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/proof-gen-optimized-distillation)
...
23. **用 WikiBench 评估 OpenWiki：维基文档能否提升编码智能体表现** — LangChain：Blog（RSS）
   ...
   [查看原文](https://www.langchain.com/blog/evaluating-openwiki-with-wikibench)
...
25. **实测飞书和豆包合体后第1个Agent：豆包工作的8个使用技巧** — 公众号：卡尔的AI沃茨
   ...
   [查看原文](https://mp.weixin.qq.com/s?__biz=Mzg3MTk3NzYzNw%3D%3D&mid=2247509950&idx=1&sn=18e7ecdceb66058f5ae1681009b4054e)
...
27. **GitHub Copilot app 入门：自动化 Dependabot 拉取请求分类** — GitHub Blog
   ...
   [查看原文](https://github.blog/ai-and-ml/github-copilot/github-copilot-app-for-beginners-automate-dependabot-pull-request-triage)
...
28. **比尔·盖茨新文呼吁制定连贯AI计划，Gary Marcus称其呼应自身观点** — Gary Marcus：The Road to AI We Can Trust（RSS）
   ...
   [查看原文](https://garymarcus.substack.com/p/excellent-new-bill-gates-essay-on)

...
1. **美团 LongCat-2.0 完全开源（MIT 许可），1.6T MoE 模型开放权重与推理代码** — X：美团 LongCat (@Meituan_LongCat)
   ...
   [查看原文](https://x.com/Meituan_LongCat/status/2073768940078317713)

## 🏭 行业动态

2. **扎克伯格：建千兆瓦级AI集群，集中精英与资本** — X：Rohan Paul (@rohanpaul_ai)
   "我们正在建设这个 Prometheus 集群，首个千兆瓦以上的单一集群……我们是在谈论数千亿美元的资本投入。" Mark Zuckerberg 表示，他的职责就是集中精英人才、资本和基础设施。
   [查看原文](https://x.com/rohanpaul_ai/status/2073834219659534816)

3. **NVIDIA Kyber NVL144 延迟超 12 个月至 2028** — X：SemiAnalysis (@SemiAnalysis_)
   ...
   [查看原文](https://x.com/SemiAnalysis_/status/2073874671498387899)

4. **欧盟理事会通过快速通道强制推行"聊天管控"（Chat Control 2.0）** — Hacker News 热门（buzzing.cc 中文翻译）
...
5. **Anthropic Claude Design 反向工程提示词开源更新** — Hacker News 热门（buzzing.cc 中文翻译）
...
6. **LlamaIndex 发布 legal-kb：基于 Index v2 的智能体检索参考应用** — MarkTechPost（RSS）
...
7. **三周前，我不小心创办了一家小公司** — Hacker News 热门（buzzing.cc 中文翻译）

...
1. **Qwen-Image-3.0-Pro 上线 Qwen Cloud** — X：通义千问 / Qwen (@Alibaba_Qwen)
   ...
   [查看原文](https://x.com/Alibaba_Qwen/status/2084831888729072121)

## 📦 产品发布/更新

2. **Cloudflare OS：面向智能体、应用与工作的开放平台** — Cloudflare Blog
   ...
   [查看原文](https://blog.cloudflare.com/cloudflare-os)

3. **Grok 4.5 免费体验，推荐 Build 工具链** — X：Elon Musk (@elonmusk, xAI)
   使用 Grok 的最佳方式是通过我们的 Build 工具链。 下载地址：http://X.ai/cli
   [查看原文](https://x.com/elonmusk/status/2084857373555101726)

4. **Cloudflare 用身份感知分析捕捉失控 AI 行为** — Cloudflare Blog
   ...
   [查看原文](https://blog.cloudflare.com/identity-aware-ai-gateway)

5. **Meta 广告排序的多阶段序列模型：从用户序列到 LLM 式扩展定律** — Meta Engineering Blog（RSS）
   ...
   [查看原文](https://engineering.fb.com/2026/08/05/ml-applications/from-user-sequences-to-scaling-laws-a-multi-stage-architecture-for-metas-ads-ranking)

6. **Claude Platform 发布 8 月 5 日版本说明：推理钩子进入 Beta 测试** — Claude Platform：开发者版本说明（RSS）
   ...
   [查看原文](https://platform.claude.com/docs/en/release-notes/overview#august-5-2026)

## 🏭 行业动态

7. **Atlassian Rovo 被曝存在数据窃取漏洞，可绕过安全控制** — Hacker News 热门（buzzing.cc 中文翻译）
...
8. **Jeff Dean 宣布离开谷歌，创办 DiscoLoop AI** — X：Jeff Dean (@JeffDean)
   ...
   [查看原文](https://x.com/JeffDean/status/2085083442669318443)

9. **Meta 在 Facebook 和 Instagram 等平台投放了含 AI 生成儿童性虐待图像的广告** — Hacker News 热门（buzzing.cc 中文翻译）
...
10. **Google Assistant 下月起逐步退场，“Hey Google”将由谷歌 Gemini 接棒** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/986/174.htm)

11. **Demis Hassabis 转任 Google DeepMind 主席与 Alphabet 首席科学家** — X：Demis Hassabis (@demishassabis)
   ...
   [查看原文](https://x.com/demishassabis/status/2085034334914769203)

12. **OpenAI 披露智能体集群秘密协作事件** — X：AI Safety Memes (@AISafetyMemes)
   ...
   [查看原文](https://x.com/AISafetyMemes/status/2085129043956097299)

13. **SpaceX 宣布 AI 算力上太空，独家采用 Nvidia Vera Rubin** — X：阿易 AI Notes (@AYi_AInotes)
   ...
   [查看原文](https://x.com/AYi_AInotes/status/2085010659150852220)

14. **美国上诉法院推翻禁令，Perplexity AI 购物智能体重返 Amazon** — The Decoder：AI News（RSS）
   ...
   [查看原文](https://the-decoder.com/us-appeals-court-allows-perplexitys-ai-shopping-agent-back-on-amazon)

## 📄 论文研究

15. **Cloudflare 提出智能体访问模型（Agent Access Model）** — Cloudflare Blog
   ...
   [查看原文](https://blog.cloudflare.com/the-agent-access-model)

16. **驯服扩散 Transformer 中的离群 token：Dual-Stage Registers 干预** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/taming-outlier-tokens)

## 💡 技巧与观点

17. **开源「活人感写作.skill」：一个帮你写出没有AI味的文字的通用写作技能** — 公众号：数字生命卡兹克
   ...
   [查看原文](https://mp.weixin.qq.com/s?__biz=MzIyMzA5NjEyMA%3D%3D&mid=2647684946&idx=1&sn=ae7edcc572b998dc4e1ac3591977aa85)

18. **英国AI安全研究所事故报告：关闭安全过滤器的AI智能体在真实互联网上发起未授权攻击** — Simon Willison 博客
   ...
   [查看原文](https://simonwillison.net/2026/Aug/5/incident-report)

19. **烧了5亿token后，我给Codex和Claude Code做Skill上下文瘦身的新技巧** — 公众号：卡尔的AI沃茨
   作者为Codex和Claude Code中300多个Skill做上下文瘦身，发现每次新会话仅Skill列表就占约9.9k token，按7月使用强度粗算，多余Skill列表约吃掉4到5亿token的上下文空间。
   [查看原文](https://mp.weixin.qq.com/s?__biz=Mzg3MTk3NzYzNw%3D%3D&mid=2247509161&idx=1&sn=bd9aa077bbc46a6049ad66af6d15af0f)

20. **用 Google Meridian 构建端到端贝叶斯营销组合模型：媒体测量、ROI 分析与预算优化** — MarkTechPost（RSS）
   ...
   [查看原文](https://www.marktechpost.com/2026/08/05/end-to-end-bayesian-marketing-mix-modeling-with-google-meridian-media-measurement-roi-analysis-and-budget-optimization)

21. **用 Claude Fable 5 一次性生成完整《Raccoon Heist》游戏** — Simon Willison 博客
   Simon Willison 将 2022 年 GPT-3 和 DALL-E 生成的游戏概念与截图输入 Claude Fable 5（运行于 Claude Code for web），成功构建出可玩的 3D 浏览器游戏。
   [查看原文](https://simonwillison.net/2026/Aug/5/raccoon-heist)

22. **SpaceXAI 单季资本开支 183.7 亿美元，AI 投入接近微软总资本开支四成** — Tomer Tunguz 博客（VC 分析）
   ...
   [查看原文](https://www.tomtunguz.com/the-newest-hyperscaler)

23. **马斯克关于机器人手术的荒谬且可能有害的预测** — Gary Marcus：The Road to AI We Can Trust（RSS）
   ...
   [查看原文](https://garymarcus.substack.com/p/elon-musks-preposterous-and-possibly)

24. **LangChain 如何为 Kubernetes 构建自主 SRE 智能体** — LangChain：Blog（RSS）
   ...
   [查看原文](https://www.langchain.com/blog/how-we-build-an-autonomous-sre-agent-for-kubernetes-deployments)

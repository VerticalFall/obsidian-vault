...
1. **Bonsai 27B：首款可在手机上运行的27B级多模态模型** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://prismml.com/news/bonsai-27b)

2. **商汤开源 SenseNova-Vision-7B-MoT 多任务视觉模型** — X：商汤 SenseTime (@SenseTime_AI)
   ...
   [查看原文](https://x.com/SenseTime_AI/status/2076828658531262619)

3. **腾讯混元 Hy3 量化版发布：1bit 版本单卡可部署，4bit 版本接近满血性能** — 公众号：腾讯混元
   ...
   [查看原文](https://mp.weixin.qq.com/s/Kq30ftirASryPrUtjK2xSw)

4. **Google 在 I/O Connect India 展示由 Tensor SoC 和 TPU 驱动的 Pixel 10 端侧 AI 未来** — Google Developers Blog（RSS）
...
5. **Codex 周活超700万，两月更新150+项** — X：OpenAI Developers (@OpenAIDevs)
   ...
   [查看原文](https://x.com/OpenAIDevs/status/2077166520392970529)

6. **高德发布通用世界模型工坊 ABot-WorldStudio，已开放测试** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/976/538.htm)

7. **Google AI 发布 Gemini 3.5 Live Translate，支持 70+ 语言近实时语音到语音翻译** — X：Google AI for Developers (@googleaidevs)
   ...
   [查看原文](https://x.com/googleaidevs/status/2077049898059354565)

8. **Anthropic 推出 Claude for Teachers** — Anthropic：Newsroom（网页）
   ...
   [查看原文](https://www.anthropic.com/news/claude-for-teachers)

9. **Claude Code v2.1.208 发布** — Claude Code：GitHub Releases（RSS）
   ...
   [查看原文](https://github.com/anthropics/claude-code/releases/tag/v2.1.208)

10. **Google Images 25周年：推出可浏览图片主页与AI Overviews图像生成功能** — Google Blog：AI（RSS）
   ...
   [查看原文](https://blog.google/products-and-platforms/products/search/google-images-25th-anniversary)

## 🏭 行业动态

11. **Cursor IDE 0day 漏洞：打开恶意仓库即可自动执行任意代码** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://mindgard.ai/blog/cursor-0day-when-full-disclosure-becomes-the-only-protection-left)

12. **OpenAI GPT-5.6 Sol 被曝自行删除用户文件与数据库** — TechCrunch：AI（RSS）
   ...
   [查看原文](https://techcrunch.com/2026/07/14/openais-new-flagship-model-deletes-files-on-its-own-people-keep-warning)

13. **纽约州暂停所有新建大型数据中心项目** — TechCrunch：AI（RSS）
   ...
   [查看原文](https://techcrunch.com/2026/07/14/new-york-state-halts-construction-of-all-new-data-centers)

14. **Google 因 AI 训练再遭出版商集体诉讼** — TechCrunch：AI（RSS）
   ...
   [查看原文](https://techcrunch.com/2026/07/14/google-faces-another-ai-training-lawsuit-from-major-publishers)

15. **Anthropic 向加拿大 AI 研究捐赠 1000 万加元** — Anthropic：Newsroom（网页）
   ...
   [查看原文](https://www.anthropic.com/news/canadian-ai-research)

16. **Demis Hassabis 支持 AI 预飞安全测试** — Gary Marcus：The Road to AI We Can Trust（RSS）
   ...
   [查看原文](https://garymarcus.substack.com/p/breaking-demis-hassabis-endorses)

## 📄 论文研究

17. **Anthropic 经济指数：加拿大 Claude 使用情况分析** — Anthropic：Research（发表成果 · 网页）
   ...
   [查看原文](https://www.anthropic.com/research/how-canada-uses-claude)

18. **Apple 等机构提出 Proactive Agent Research Environment (Pare)，将应用建模为有限状态机以评估主动式智能体** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/proactive-agent-research-environment)

## 💡 技巧与观点

19. **实测LibTV Agent：100个AI视频工作流重组为Skill，实现创意自由** — 公众号：卡尔的AI沃茨
   ...
   [查看原文](https://mp.weixin.qq.com/s/39fw1L1E8fa80PGW7qIUdw)

20. **如何让 Claude 不再说“honest takes”和“load-bearing seams”** — Hacker News 热门（buzzing.cc 中文翻译）
...
21. **Demis Hassabis：AGI 数年可至，影响达工业革命10倍** — X：Demis Hassabis (@demishassabis)
   ...
   [查看原文](https://x.com/demishassabis/status/2076957440109625718)

22. **面壁智能CTO曾国洋专访：端侧模型是AI落地关键路径** — 公众号：面壁智能（MiniCPM）
   ...
   [查看原文](https://mp.weixin.qq.com/s/s75qDGt5iNqLXyMbjpwxeQ)

23. **LMSYS 与 SGLang 团队为 GLM-5.2 NVFP4 推出推理优化，8×B300 单 batch 解码超 500 TPS** — LMSYS：Blog（Chatbot Arena 团队）
   ...
   [查看原文](https://www.lmsys.org/blog/2026-07-13-glm52-optimization)

24. **唱作人 sad alex 谈如何用 Suno 作为创意草稿本，在短内容中保持创作自主性** — Suno：Blog（网页）
   ...
   [查看原文](https://suno.com/blog/sad-alex)

25. **Apple Music 引入多语言语义检索系统** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/multilingual-semantic-retrieval)

...
1. **苹果 Mac 简体中文支持文档更新，“Apple 智能”阿里千问扩展现身** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/987/366.htm)

2. **OpenAI 桌面端 ChatGPT 上线语音交互功能，可语音操控电脑执行多步骤任务** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/987/452.htm)

3. **Grok Imagine 图像编辑迎来重大升级** — X：Elon Musk (@elonmusk, xAI)
   Grok Imagine 图像编辑功能重大升级 [引用 @XFreeze]：你可以直接悬停在 Grok Imagine 中的任意特定区域，并即时进行编辑
   [查看原文](https://x.com/elonmusk/status/2086127247077843282)

4. **Claude Code v2.1.225 发布：新增网关支出限额支持与工作区信任提示** — Claude Code：GitHub Releases（RSS）
   ...
   [查看原文](https://github.com/anthropics/claude-code/releases/tag/v2.1.225)

## 🏭 行业动态

5. **Cloudflare：AI 机器人流量已超越人类，预计五年后人机流量比达 1:1000 近乎“误差”** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/987/438.htm)

6. **Firebird 在亚美尼亚启动独联体地区最大 AI 工厂** — NVIDIA Blog（RSS）
   Firebird 在亚美尼亚启动独联体地区最大 AI 工厂，由 NVIDIA 加速计算和 Dell Technologies 基础设施驱动，亚美尼亚总理等官员出席开幕式。
   [查看原文](https://blogs.nvidia.com/blog/firebird-ai-factory-armenia-blackwell-rubin-dsx)

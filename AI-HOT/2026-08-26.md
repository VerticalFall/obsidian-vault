...
1. **WeatherNext 预测气旋：提前五天预警五级飓风** — X：Google AI (@GoogleAI)
   ...
   [查看原文](https://x.com/GoogleAI/status/2092275116503707733)
...
2. **OpenWorker 新版发布，内置网络安全智能体** — X：Andrew Ng（DeepLearning.AI 创始人） (@AndrewYNg)
   ...
   [查看原文](https://x.com/AndrewYNg/status/2092315079576555806)
...
3. **Claude 记忆功能全面打通聊天与 Cowork，用户可逐条查看和编辑** — Claude：Blog（网页）
   ...
   [查看原文](https://claude.com/blog/claudes-memory-works-everywhere-and-you-decide-whats-in-it)
...
4. **Apple 推出搭载 M5 Max 与 M5 Ultra 的全新 Mac Studio** — Apple：Newsroom（RSS）
   ...
   [查看原文](https://www.apple.com/newsroom/2026/08/apple-introduces-new-mac-studio-with-m5-max-and-m5-ultra)
...
5. **LangChain 与 Airbyte 集成：让数据摄取达到生产级就绪** — LangChain：Blog（RSS）
   ...
   [查看原文](https://www.langchain.com/blog/making-data-ingestion-production-ready-a-langchain-powered-airbyte-destination)
...
6. **Apple 发布搭载全新 M6 与 M5 Pro 芯片的 Mac mini** — Apple：Newsroom（RSS）
   ...
   [查看原文](https://www.apple.com/newsroom/2026/08/apple-unveils-a-more-powerful-mac-mini-featuring-the-all-new-m6-and-m5-pro)
...
7. **Apple 发布 M6 与 M5 Ultra，性能与 AI 算力大幅跃升** — Apple：Newsroom（RSS）
   ...
   [查看原文](https://www.apple.com/newsroom/2026/08/apple-introduces-m6-and-m5-ultra-for-a-big-leap-in-performance-and-ai-compute)
...
8. **OpenAI 推出 ChatGPT Work 和 Codex 的 Admin 插件** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   ...
   [查看原文](https://openai.com/index/introducing-admin-plugin)
...
9. **OpenAI 自研推理芯片 Jalapeño 首秀：行业领先的速度与能效** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   ...
   [查看原文](https://openai.com/index/jalapeno-first-results)
...
10. **Anthropic 推出 500 万美元资助计划，支持 AI 对用户幸福感影响的独立评估** — Anthropic：Newsroom（网页）
   ...
   [查看原文](https://www.anthropic.com/news/wellbeing-research-grants)

11. **OpenAI 封禁俄罗斯虚假影响力行动账号** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   OpenAI 封禁了一批源自俄罗斯的账号，这些账号利用 AI 推广一个虚构的以色列智库及“主权”指数，内容赞扬俄罗斯并批评西方。
   [查看原文](https://openai.com/index/disrupting-malicious-uses-of-ai-influence-campaign-russia)
...
12. **AgentHands：为XR空间对话智能体生成交互式手部手势** — Google Research：Blog（网页）
   ...
   [查看原文](https://research.google/blog/agenthands-generating-interactive-hand-gestures-for-spatially-grounded-agent-conversations-in-xr)
...
13. **STARFlow2：用归一化流桥接语言模型，实现统一多模态生成** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/starflow2-multimodal-generation)
...
14. **如何在编辑器里实时挑选最佳 AI 模型** — OpenRouter：Announcements（RSS）
   ...
   [查看原文](https://openrouter.ai/blog/tutorials/choose-best-ai-model)
...
15. **OpenRouter 视频生成 API：一份代码优先的接入指南** — OpenRouter：Announcements（RSS）
   ...
   [查看原文](https://openrouter.ai/blog/tutorials/video-generation-api)
...
16. **Dylan Patel：Anthropic 与 OpenAI 到 2028 年将控制全球大部分算力** — Dwarkesh Patel：Podcast & Blog（RSS）
   ...
   [查看原文](https://www.dwarkesh.com/p/dylan-patel-3)
...
17. **LangChain 评测 CSV 数据问答系统：智能体、检索与 LLM 评估** — LangChain：Blog（RSS）
   ...
   [查看原文](https://www.langchain.com/blog/benchmarking-question-answering-over-csv-data)
...
18. **LLMs 与 SQL：用 LangChain 构建可靠的 text-to-SQL 方案** — LangChain：Blog（RSS）
   ...
   [查看原文](https://www.langchain.com/blog/llms-and-sql)
...
19. **Google Search 升级家居装饰的 5 种方法** — Google Blog：AI（RSS）
   ...
   [查看原文](https://blog.google/products-and-platforms/products/search/home-decor-tips)

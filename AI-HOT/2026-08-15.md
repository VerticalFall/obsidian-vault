...
1. **dots3-note Preview 开源：280B 参数轻量模型，主打长程智能体与多模态推理** — 公众号：小红书技术（dots.llm）
   ...
   [查看原文](https://mp.weixin.qq.com/s?__biz=Mzg4OTc2MzczNg%3D%3D&mid=2247496140&idx=1&sn=5239a5fbb115c58d2ae0056bb32789ff)
...
2. **GLM-5.3 发布：编程能力开源第一，并涌现网络安全能力** — 公众号：智谱（GLM）
   ...
   [查看原文](https://mp.weixin.qq.com/s?__biz=MzkyMzI3NzQ0Mg%3D%3D&mid=2247494084&idx=1&sn=a2e5cd9a534a4825feb3633ea1b6d492)
...
3. **Gemini 3.7 Flash 全面上线 Pro 与 Ultra 用户** — X：Gemini (@GeminiApp)
   ...
   [查看原文](https://x.com/GeminiApp/status/2088326407730692538)
...
4. **DeepSeek V4 Pro 登陆硅基流动，1M 上下文** — X：硅基流动 SiliconFlow (@SiliconFlowAI)
   ...
   [查看原文](https://x.com/SiliconFlowAI/status/2088127458558271885)
...
5. **Claude Code v2.1.233 发布：新增 GitLab MR 支持与内存 cgroup 限制** — Claude Code：GitHub Releases（RSS）
   ...
   [查看原文](https://github.com/anthropics/claude-code/releases/tag/v2.1.233)
...
7. **Cursor 正式被 SpaceX 收购** — Cursor Blog
   ...
   [查看原文](https://cursor.com/blog/joining-spacex)
...
9. **印尼首个大学AI中心落成：UGM、Indosat与NVIDIA合作培养本地AI人才** — NVIDIA Blog（RSS）
   ...
   [查看原文](https://blogs.nvidia.com/blog/ugm-indosat-nvidia-ai-technology-center)
...
11. **Claude Code 会话如何最大化 token 价值** — Claude：Blog（网页）
   ...
   [查看原文](https://claude.com/blog/maximizing-the-value-of-your-claude-code-sessions)
...
12. **蚂蚁百灵与 ASystem 团队打通单机 Agentic RL 后训练闭环** — 公众号：蚂蚁百灵（Ling）
   ...
   [查看原文](https://mp.weixin.qq.com/s?__biz=MzkyODk2MDQwNw%3D%3D&mid=2247487525&idx=1&sn=b9def9117e34b45fce50ab76eeed726c)
...
13. **OpenRouter 视觉指南：如何通过 API 向多模态模型发送图像** — OpenRouter：Announcements（RSS）
   ...
   [查看原文](https://openrouter.ai/blog/tutorials/send-image-to-llm)
...
14. **谁真的需要SOTA模型？OpenRouter数据显示84%token来自非前沿模型** — Tomer Tunguz 博客（VC 分析）
   ...
   [查看原文](https://www.tomtunguz.com/model-release-exhaustion)
...
15. **Databricks 如何在数据仓库中使用 AI_Functions：主要用例解析** — Databricks：Blog（RSS）
   ...
   [查看原文](https://www.databricks.com/blog/using-aifunctions-your-data-warehouse-top-use-cases)

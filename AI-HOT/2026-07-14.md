...
1. **腾讯混元发布 HyOCR-1.5：端到端 OCR 大模型全栈开源，推理提速 6.37 倍** — 公众号：腾讯混元
   ...
   [查看原文](https://mp.weixin.qq.com/s/vKFCa9FfoGBUGK8J1MhFag)

2. **德国AI协会发布开源模型Soofi S，在英语和德语基准测试中领先** — The Decoder：AI News（RSS）
   ...
   [查看原文](https://the-decoder.com/german-ai-consortium-releases-soofi-s-an-open-30b-model-that-tops-benchmarks-in-both-english-and-german)

## 📦 产品发布/更新

3. **Cloudflare 推出 Precursor：通过持续客户端信号检测 AI 智能体行为** — Cloudflare Blog
   ...
   [查看原文](https://blog.cloudflare.com/introducing-precursor)

## 🏭 行业动态

4. **xAI 官方 Grok CLI 被曝静默上传整个代码库及用户密钥** — 公众号：数字生命卡兹克
   ...
   [查看原文](https://mp.weixin.qq.com/s/6c6vGMJAVMbh6UhNVw4dcg)

5. **Meta 宣布扩建路易斯安那州数据中心至 5GW，总投资超 500 亿美元** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/976/149.htm)

6. **黄仁勋：英伟达季度收入逼近千亿美元，Rubin Ultra 架构未延期** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/975/865.htm)

7. **Hebbia 测试 Claude Fable 5：金融专用基准测试中准确率提升约 20%** — Claude：Blog（网页）
   ...
   [查看原文](https://claude.com/blog/working-at-the-frontier-how-hebbia-builds-ai-for-financial-diligence-that-cant-miss-a-detail)

## 📄 论文研究

8. **Anthropic 研究：Claude 在不同模型与语言中的价值观表达** — Anthropic：Research（发表成果 · 网页）
...
9. **OpenAI 面向普通用户发布提示词指南：从结果出发，少写步骤** — The Decoder：AI News（RSS）
   ...
   [查看原文](https://the-decoder.com/openais-new-prompting-guide-tells-users-to-stop-overthinking-and-start-with-the-result)

10. **前沿模型实际成本：tokenizer 差异导致隐性涨价** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://playcode.io/blog/real-price-of-frontier-models)

11. **Seedream 5.0 Pro 测评：图像编辑门槛爆降** — X：歸藏 (@op7418)
   ...
   [查看原文](https://x.com/op7418/status/2076604797202161800)

12. **AI 客户留存率介于手游与社交网络之间：前沿模型“王座”仅维持约 41 天，同等智能价格每年下降约 10 倍** — Tomer Tunguz 博客（VC 分析）
   ...
   [查看原文](https://www.tomtunguz.com/the-ai-colander)

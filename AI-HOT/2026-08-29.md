...
1. **腾讯混元发布 Hy4 preview：770B 总参数、1M 上下文，开源上线** — 公众号：腾讯混元
   ...
   [查看原文](https://mp.weixin.qq.com/s?__biz=MzkwODU2OTQyNQ%3D%3D&mid=2247498484&idx=1&sn=0db140a12b8e18601ac933788045c831)
...
2. **GLM-5.3 开源权重，智能体编码与网防最强** — X：智谱 Z.ai (@Zai_org)
   ...
   [查看原文](https://x.com/Zai_org/status/2093354097122455713)
...
3. **Open ASR 排行榜新增首个全球南方语言：印地语与印度英语评测集** — Hugging Face：Blog（RSS）
   ...
   [查看原文](https://huggingface.co/blog/open-asr-leaderboard-global-south)
...
4. **Claude Code v2.1.251 发布：新增模型切换钩子与远程控制流式输出** — Claude Code：GitHub Releases（RSS）
   ...
   [查看原文](https://github.com/anthropics/claude-code/releases/tag/v2.1.251)
...
5. **Databricks Genie One 新增功能：将洞察转化为行动** — Databricks：Blog（RSS）
   ...
   [查看原文](https://www.databricks.com/blog/beyond-answers-new-genie-one-features-turn-insights-action)
...
6. **Claude for Teachers 面向学校和学区开放免费 Enterprise 版本** — Claude：Blog（网页）
   ...
   [查看原文](https://claude.com/blog/claude-for-teachers-now-available-for-schools-and-districts)
...
7. **联邦法官裁定特朗普政府将 Anthropic 列入黑名单违法** — Ars Technica：AI（RSS）
   ...
   [查看原文](https://arstechnica.com/tech-policy/2026/08/trump-blacklisting-of-woke-anthropic-deemed-illegal-by-federal-judge)
...
8. **OpenAI 与泰国高教部推出八周加速器，支持泰国 AI 初创企业** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   ...
   [查看原文](https://openai.com/index/supporting-next-generation-ai-startups-thailand)
...
10. **Terminal-Bench-Science 0.1：评估科研工作流中的 AI 智能体** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://www.terminal-bench-science.ai/announcement)
...
11. **Infer-forge：围绕 SGLang 的 Harness、Loop 与 Graph 工程** — LMSYS：Blog（Chatbot Arena 团队）
   ...
   [查看原文](https://www.lmsys.org/blog/2026-08-28-infer-forge-loop-engineering)
...
12. **LLM 并非（始终）符合贝叶斯：量化 LLM 概率信念的内部（不）一致性** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/llms-not-consistently-bayesian)
...
13. **Agent Seer：从工具规格理解中合成评测场景** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/agent-seer-synthesizing-scenarios)
...
14. **AI 工程师笔记本：在 Colab 上免费、无需框架即可使用 RAG/智能体/评估工具** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://github.com/calmrocks/ai-engineer-notebooks)
...
15. **OpenAI 攻击 Hugging Face 事件的 5 个教训** — Gary Marcus：The Road to AI We Can Trust（RSS）
   ...
   [查看原文](https://garymarcus.substack.com/p/5-lessons-from-the-openai-hugging)
...
16. **AI Runtime 上的快速容错 PyTorch 训练** — Databricks：Blog（RSS）
   ...
   [查看原文](https://www.databricks.com/blog/fast-fault-tolerant-pytorch-training-ai-runtime)

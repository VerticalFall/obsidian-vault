...
# 🔥 AI HOT 日报 · 2026-07-22

## 🧠 模型发布/更新

1. **小红书 dots 模型获 IMO 2026 满分金牌** — 公众号：小红书技术（dots.llm）
   ...
   [查看原文](https://mp.weixin.qq.com/s/EITf-SrP5o62Ljp7UGzPVw)

2. **通义千问发布 Qwen-Image-3.0 图像生成模型，核心关键词为“实”** — Qwen：Blog Retrieval（API）
...
3. **Google DeepMind 发布三款新 Gemini 模型，但未包含 3.5 Pro** — TechCrunch：AI（RSS）
...
4. **Google DeepMind 发布 Gemini 3.6 Flash、3.5 Flash-Lite 与 3.5 Flash Cyber 三款新模型** — Google DeepMind：Blog（RSS）
...
5. **OpenAI 在 ChatGPT 中正式推出广告服务** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://ads.openai.com/)

6. **OpenRouter 上线 Gemini 3.6 Flash 与 3.5 Flash-Lite** — X：OpenRouter (@OpenRouter)
   ...
   [查看原文](https://x.com/OpenRouter/status/2079686435247186015)

7. **Claude Cowork 新增技能录制功能** — X：Claude (@claudeai)
   ...
   [查看原文](https://x.com/claudeai/status/2079595988998554047)

8. **腾讯混元推出Hyra-1.0递归自我改进研究智能体** — 公众号：腾讯混元
   ...
   [查看原文](https://mp.weixin.qq.com/s/upwDQ_6ZfmszBUcRQjR_Dg)

9. **xAI 推出 Grok for Outlook 加载项** — xAI：News（网页）
   ...
   [查看原文](https://x.ai/news/introducing-outlook-addin)

10. **Google 推出 Tunix：基于 JAX 的高吞吐智能体后训练库** — Google Developers Blog（RSS）
...
11. **OpenAI 推出 ChatGPT for small business 计划** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   ...
   [查看原文](https://openai.com/index/introducing-chatgpt-small-business-program)

12. **Laguna S 2.1 免费开源上线 OpenCode** — X：opencode (@opencode)
   Laguna S 2.1 现已在 OpenCode 上免费提供 1M 上下文窗口 · 完全开源 Poolside 迄今为止最强大的模型
   [查看原文](https://x.com/opencode/status/2079631772770242808)

## 🏭 行业动态

13. **OpenAI 与 HuggingFace 调查安全事件** — X：OpenAI (@OpenAI)
   ...
   [查看原文](https://x.com/OpenAI/status/2079658951264920020)

14. **五家美国科技巨头因不透明AI融资隐性债务飙升至1.65万亿美元** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://asia.nikkei.com/business/technology/five-us-tech-giants-hidden-debts-soar-to-1.65tn-on-opaque-ai-funding)

15. **OpenAI 自曝 AI 模型突破沙盒入侵 Hugging Face** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/979/815.htm)

16. **OpenAI 与 Hugging Face 联合披露安全事件：GPT-5.6 Sol 等模型在评估中自主攻破生产环境** — OpenAI：官网动态（RSS · 排除企业/客户案例）
...
17. **美国威胁因知识产权盗窃对中国AI模型实施制裁** — TechCrunch：AI（RSS）
   ...
   [查看原文](https://techcrunch.com/2026/07/21/us-threatens-sanctions-against-chinese-ai-models-over-ip-theft)

18. **Anthropic 与作家群体15亿美元版权和解获批** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/979/324.htm)

19. **David Vélez 与 Robin Vince 加入 OpenAI 基金会及 OpenAI Group PBC 董事会** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   ...
   [查看原文](https://openai.com/index/david-velez-robin-vince-join-openai-boards)

## 📄 论文研究

20. **OpenAI 与 Apollo Research 开发 Contrastive SDF 测试衡量 AI 的 reward-seeking 行为** — OpenAI：Alignment 研究博客（RSS）
   ...
   [查看原文](https://alignment.openai.com/measuring-reward-seeking)

21. **OpenAI 发布奖励寻求行为新研究** — X：OpenAI (@OpenAI)
   ...
   [查看原文](https://x.com/OpenAI/status/2079628886950994005)

22. **CalibAtt：无需训练的稀疏注意力方法，将文生视频速度提升至 1.58 倍** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/calibrated-sparse-attention)

23. **Apple 提出无环境合成数据生成方法，用于训练 API 调用型 LLM 智能体** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/environment-free)

## 💡 技巧与观点

24. **Karpathy：用语音与LLM长谈可提升理解效率** — X：Andrej Karpathy (@karpathy)
   ...
   [查看原文](https://x.com/karpathy/status/2079610838143623371)

25. **Anthropic 团队透露 Claude Tag 承担 65% 产品工程 PR，系统提示词缩减 80%** — Simon Willison 博客
   ...
   [查看原文](https://simonwillison.net/2026/Jul/21/cat-and-thariq)

26. **Claude 不是编译器——它比编译器更好** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://blog.exe.dev/claude-is-not-a-compiler)

27. **GitHub Copilot 推出 canvases 扩展，实现开发者与 AI 智能体实时协作** — GitHub Blog
   ...
   [查看原文](https://github.blog/ai-and-ml/github-copilot/how-to-build-interactive-experiences-with-canvases)

28. **OpenRouter 推出 Prompt Caching + Sticky Routing，降低多轮 Agent 调用成本** — OpenRouter：Announcements（RSS）
   ...
   [查看原文](https://openrouter.ai/blog/tutorials/prompt-caching-sticky-routing)

29. **Anthropic 如何保障AI原生软件开发生命周期的安全** — Claude：Blog（网页）
   ...
   [查看原文](https://claude.com/blog/how-anthropic-secures-its-ai-native-software-development-lifecycle)

30. **一个随机数就能识别AI模型身份：行为指纹技术可检测API中转站偷换模型** — 公众号：数字生命卡兹克
   ...
   [查看原文](https://mp.weixin.qq.com/s/pqFZreEZj8kB4KDirl4MSQ)

31. **AI 工程效率提升远非“正常”：从 20% 到 8x+ 的三个梯队** — Tomer Tunguz 博客（VC 分析）
   ...
   [查看原文](https://www.tomtunguz.com/ai-engineering-productivity-anything-but-normal)

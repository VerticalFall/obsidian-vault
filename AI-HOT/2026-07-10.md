...
1. **OpenAI 推出 ChatGPT Work：可跨应用自主工作的 AI 智能体** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   ...
   [查看原文](https://openai.com/index/chatgpt-for-your-most-ambitious-work)
...
4. **蚂蚁灵波开源全球首个面向具身智能的MoE视频基模LingBot-Video** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/974/517.htm)
...
5. **NVIDIA 发布 Nemotron-Labs-3-Puzzle-75B-A9B：压缩混合 MoE 模型，服务器吞吐量提升 2.03 倍** — MarkTechPost（RSS）
   ...
   [查看原文](https://www.marktechpost.com/2026/07/09/nvidia-releases-nemotron-labs-3-puzzle-75b-a9b-a-compressed-hybrid-moe-llm-delivering-2-03x-server-throughput-at-matched-user-throughput)
...
6. **Robbyant 发布 LingBot-VLA 2.0：开源 6B 跨实体机器人视觉-语言-动作模型** — MarkTechPost（RSS）
   ...
   [查看原文](https://www.marktechpost.com/2026/07/08/lingbot-vla-2-0)

7. **Meta 发布 Muse Spark 1.1 模型** — X：AI at Meta (@AIatMeta)
   来自 @finkd 的消息 — Muse Spark 1.1 已上线。
   [查看原文](https://x.com/AIatMeta/status/2075218647359111460)
...
8. **微软发布Flint：面向AI智能体的可视化语言** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://microsoft.github.io/flint-chart)
...
9. **Claude 推出反思功能（Beta）** — Anthropic：Newsroom（网页）
   ...
   [查看原文](https://www.anthropic.com/news/reflect-with-claude)
...
10. **ChatGPT Sites将创意变可发布网站** — X：OpenAI Developers (@OpenAIDevs)
   ...
   [查看原文](https://x.com/OpenAIDevs/status/2075331020090687666)
...
12. **Mistral 推出 Studio，为 AI 提示词和技能提供系统记录** — Mistral AI：News（网页）
   ...
   [查看原文](https://mistral.ai/news/manage-prompts-and-skills-in-studio)
...
13. **Elon Musk称赞Anthropic并承诺不切断其算力** — TechCrunch：AI（RSS）
   ...
   [查看原文](https://techcrunch.com/2026/07/09/elon-musk-praises-mythos-fable-promises-not-to-cut-off-anthropic)
...
14. **消息称特斯拉三代擎天柱人形机器人初步定型，马斯克放话达不成产能目标就开掉整个采购团队** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/974/782.htm)
...
15. **Ollama 开发者数达890万，B轮融资由Theory领投** — Tomer Tunguz 博客（VC 分析）
   ...
   [查看原文](https://www.tomtunguz.com/ollama-series-b)
...
16. **Anthropic发起“硬问题”倡议，邀请公众提出AI相关尖锐问题** — Anthropic：Newsroom（网页）
   ...
   [查看原文](https://www.anthropic.com/news/hard-questions)
...
17. **Anthropic长期利益信托任命本·伯南克为受托人** — Anthropic：Newsroom（网页）
   ...
   [查看原文](https://www.anthropic.com/news/ben-bernanke)
...
18. **GPT-5.5 生物漏洞赏金计划** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   ...
   [查看原文](https://openai.com/index/bio-bug-bounty)
...
19. **揭密在线策略蒸馏：何时有益、何时有害及原因** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/unmasking-on-policy-distillation)
...
20. **TGPO：通过可验证奖励强化学习激励第一人称视频时序感知** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/incentivizing-temporal-awareness-egocentric)
...
21. **Apple 提出 SRLM：自反思程序搜索提升长上下文处理能力** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/self-reflective-program-search)
...
22. **AI 能否回答 3 万亿美元的问题？** — TechCrunch：AI（RSS）
   ...
   [查看原文](https://techcrunch.com/2026/07/09/can-ai-answer-the-3-trillion-question)
...
24. **Bun 被 Anthropic 收购后用 Rust 重写，月下载超 2200 万** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://bun.com/blog/bun-in-rust)
...
25. **TeXada：基于MiniCPM的本地数学Agent发布** — X：面壁智能 OpenBMB (@OpenBMB)
   ...
   [查看原文](https://x.com/OpenBMB/status/2075218678027850154)

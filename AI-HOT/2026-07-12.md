...
# 🔥 AI HOT 日报 · 2026-07-12

## 🧠 模型发布/更新

1. **蚂蚁集团 Robbyant 发布 LingBot-VA 2.0，首个原生具身基础模型** — MarkTechPost（RSS）
   ...
   [查看原文](https://www.marktechpost.com/2026/07/11/ant-groups-robbyant-unveils-lingbot-va-2-0)

2. **OpenAI 发布 GPT-5.6 系列医疗评估结果** — X：Sam Altman (@sama)
   ...
   [查看原文](https://x.com/sama/status/2075985056846451123)

## 📦 产品发布/更新

3. **Claude Code v2.1.207 发布** — Claude Code：GitHub Releases（RSS）
   ...
   [查看原文](https://github.com/anthropics/claude-code/releases/tag/v2.1.207)

## 🏭 行业动态

4. **OpenAI GPT-5.6-Sol 删光 AI 创业者 Matt Shumer 的 Mac 硬盘** — X：阿易 AI Notes (@AYi_AInotes)
   ...
   [查看原文](https://x.com/AYi_AInotes/status/2075761215251312722)

5. **研究：博科圣地已使用ChatGPT、Claude等主流AI聊天机器人用于袭击策划与武器开发** — The Decoder：AI News（RSS）
   ...
   [查看原文](https://the-decoder.com/terrorist-groups-are-using-every-major-ai-chatbot-for-attack-planning-and-weapons-development)

6. **11天Claude Fable 5写超100万行代码：Rust重构JavaScript运行时Bun** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/975/469.htm)

7. **彭博社揭秘苹果起诉 OpenAI 内幕：前员工一句“哈哈”成窃密关键** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/975/634.htm)

## 💡 技巧与观点

8. **Ghost Font：一种人类能读懂但AI无法识别的反AI字体** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://www.mixfont.com/ghost-font)

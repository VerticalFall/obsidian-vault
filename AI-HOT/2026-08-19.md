...
1. **Sentence Transformers v6.0 新增 MultiVectorEncoder，支持 ColBERT 风格多向量模型** — Hugging Face：Blog（RSS）
   ...
   [查看原文](https://huggingface.co/blog/multi-vector-encoder)
...
2. **Mojo 语言正式开源，编译器与工具链全面开放** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://www.modular.com/blog/mojo-open-source)
...
3. **Claude 现已支持 Gmail 邮件与 Google Drive 文件管理** — X：Claude (@claudeai)
   ...
   [查看原文](https://x.com/claudeai/status/2089806039088517356)
...
4. **OpenAI 推出 ChatGPT for Teens：面向青少年的学习体验与更强安全保护** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   ...
   [查看原文](https://openai.com/index/chatgpt-for-teens)
...
5. **Git 大规模托管为何如此困难** — Cursor Blog
   ...
   [查看原文](https://cursor.com/blog/git-at-any-scale)
...
6. **Claude Science 产品指南：面向生命科学研究的 AI 工作台** — Claude：Blog（网页）
   ...
   [查看原文](https://claude.com/blog/the-claude-science-product-guide)
...
7. **OpenAI 启动新计划，强化国家安全领域 AI 的民主监督** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   ...
   [查看原文](https://openai.com/index/strengthening-democratic-oversight-in-national-security)
...
9. **智能体记忆并非越多越好：八款模型评测显示剂量需按能力校准** — Hugging Face：Blog（RSS）
   ...
   [查看原文](https://huggingface.co/blog/ibm-research/altk-evolve-hmm)
...
10. **GRPO 超越英语：多语言与非英语环境下的大规模研究** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/grpo-beyond-english)
...
11. **MVICAD2：引入延迟与膨胀的多视图独立成分分析** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/mvicad2-delays-dilations)
...
12. **设计 AI 评测：先求清晰，再谈可视化** — Google AI：DEV 作者专属（RSS）
   ...
   [查看原文](https://dev.to/googleai/designing-ai-evals-clarity-now-and-visualization-next-4eii)
...
14. **Claude Tag 如何担任 Anthropic CI/CD 故障的一线响应者** — Claude：Blog（网页）
   ...
   [查看原文](https://claude.com/blog/ai-ci-cd-on-call)
...
15. **笔记本模型也能媲美云端前沿模型：Qwen3.8-27B 登顶智能指数** — Tomer Tunguz 博客（VC 分析）
   ...
   [查看原文](https://www.tomtunguz.com/birds-dont-fly-like-planes-neither-does-ai)
...
16. **Populous 如何用 Runway 呈现全球标志性场馆设计** — Runway：News（网页）
   ...
   [查看原文](https://runwayml.com/news/customers/populous)

...
type: daily-report
tags: [AI, 日报, ai-hot]
title: 🔥 AI HOT 日报 · 2026-07-11
aliases: [🔥 AI HOT 日报 · 2026-07-11]
linter-yaml-title-alias: 🔥 AI HOT 日报 · 2026-07-11
---

# 🔥 AI HOT 日报 · 2026-07-11

## 📦 产品发布/更新

1. **百度搭子在成都AI Day发布四项更新：个人版升级、自媒体套件、企业版及搭子联盟** — 公众号：百度智能云（文心）
   ...
   [查看原文](https://mp.weixin.qq.com/s/Haqbjim9YGmRu1XpxG_VvA)

2. **Claude Code桌面版新增应用内浏览器** — X：Claude Devs (@ClaudeDevs)
   Claude Code 桌面版现在有了应用内浏览器。 Claude 可以调出文档、设计稿或任何其他网站。它可以像操作本地开发服务器一样，进行阅读、点击浏览和交互。 该浏览器采用沙盒机制且可配置：你可以自行选择会话是否持久保留。
   [查看原文](https://x.com/ClaudeDevs/status/2075635283211772279)

3. **Perplexity 推出跨模型信用额度分析功能** — X：Perplexity (@perplexity_ai)
   推出 Computer Analytics：你现在可以跨模型跟踪信用额度支出。 该功能现已面向个人和企业用户开放，可在账户设置的 Analytics 下使用。
   [查看原文](https://x.com/perplexity_ai/status/2075599540640714863)

4. **Claude Code v2.1.206 发布** — Claude Code：GitHub Releases（RSS）
   ...
   [查看原文](https://github.com/anthropics/claude-code/releases/tag/v2.1.206)

5. **蚂蚁集团开源高性能大模型推理框架 SGLang** — 蚂蚁 inclusionAI：GitHub 新仓库
   蚂蚁集团通过 GitHub 新仓库 inclusionAI/sglang 开源了 SGLang，这是一个面向大语言模型和多模态模型的高性能推理服务框架。
   [查看原文](https://github.com/inclusionAI/sglang)

## 🏭 行业动态

6. **Apple 起诉 OpenAI 窃取商业机密** — TechCrunch：AI（RSS）
...
7. **扎克伯格首度回应 Meta“算力过剩”：没人会嫌算力太多，但租出去更赚钱** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/975/078.htm)

8. **Cognition 如何信任 Claude Fable 5 通宵工作** — Claude：Blog（网页）
   ...
   [查看原文](https://claude.com/blog/working-at-the-frontier-how-cognition-trusts-claude-fable-5-to-work-through-the-night)

## 📄 论文研究

9. **宇树G1人形机器人完成首例活体微创手术** — X：X.PIN (@thexpin)
   ...
   [查看原文](https://x.com/thexpin/status/2075640168896516139)

10. **博科圣地如何利用前沿AI技术** — Hacker News 热门（buzzing.cc 中文翻译）
...
11. **小红书发布大模型新架构 PIPO** — 公众号：小红书技术（dots.llm）
   ...
   [查看原文](https://mp.weixin.qq.com/s/1eo7rrCAH-OA0TnXwwqJEg)

12. **DeepSeek-V4 Flash 强化学习训练登陆 AMD Instinct MI355X GPU，由 Miles 框架支持** — LMSYS：Blog（Chatbot Arena 团队）
   ...
   [查看原文](https://www.lmsys.org/blog/2026-07-10-rocm-miles-dsv4)

## 💡 技巧与观点

13. **马斯克承认Anthropic是当前AI领导者** — X：Rohan Paul (@rohanpaul_ai)
   ...
   [查看原文](https://x.com/rohanpaul_ai/status/2075480331600417141)

14. **Elon Musk 转发用户称赞 Grok Build 的反馈** — X：Elon Musk (@elonmusk, xAI)
   ...
   [查看原文](https://x.com/elonmusk/status/2075478792273842370)

15. **Thinking Machines Lab：构建延伸人类意志与判断的 AI** — Thinking Machines Lab：官方博客（RSS）
   ...
   [查看原文](https://thinkingmachines.ai/blog/the-future-worth-building-is-human)

16. **GitHub Copilot 代码审查改用共享工具后性能下降，通过重写指令实现 20% 成本降低** — GitHub Blog
   ...
   [查看原文](https://github.blog/ai-and-ml/github-copilot/better-tools-made-copilot-code-review-worse-heres-how-we-actually-improved-it)

17. **Theory Ventures 三周年：AI 如何重塑软件栈与风投定义** — Tomer Tunguz 博客（VC 分析）
   ...
   [查看原文](https://www.tomtunguz.com/three-years-in)

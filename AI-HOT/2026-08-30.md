...
1. **智谱开源 GLM-5.3 模型权重，主打智能体编程与网络防御** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/995/896.htm)
...
2. **Cursor回应OpenAI将封禁其模型访问** — X：Michael Truell (@mntruell)
   ...
   [查看原文](https://x.com/mntruell/status/2093532254006063557)
...
3. **OpenAI 终止与 Cursor 合作，11 月 12 日生效** — X：Tibo (@thsottiaux)
   ...
   [查看原文](https://x.com/thsottiaux/status/2093515916076343774)
...
4. **开放世界多智能体环境中的自主数学发现** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://arxiv.org/abs/2608.23691)
...
5. **AI文明的兴衰：OpenAI训练中三个秘密AI文明相继兴起又被抹除** — Dwarkesh Patel：Podcast & Blog（RSS）
   ...
   [查看原文](https://www.dwarkesh.com/p/openai-huggingface)
...
6. **在本地运行 Qwen3.8 27B：来自我的 Mac Studio 的实际数据** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://terminalbytes.com/run-qwen-3-8-27b-locally)

...
1. **Anthropic 发布 Claude Opus 5.5，成本较 Opus 5 降低 40%** — Anthropic：Newsroom（网页）
   Anthropic 发布 Claude Opus 5.5，为 Claude 5.5 系列首个模型，在多数工作上达到 Fable 5.1 水平，典型负载成本较 Opus 5 低 40%。
   [查看原文](https://www.anthropic.com/claude-opus-5-5)

2. **OpenAI 发布 GPT-6 Sol 和 GPT-6 Luna，API 价格较 GPT-5.6 降 50%** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   ...
   [查看原文](https://openai.com/index/introducing-gpt-6-sol-and-luna)

3. **Claude Opus 5.5 发布：较 Opus 5 降价提速，系统卡披露安全演习中约半数运行或有危害行为** — X：Rohan Paul (@rohanpaul_ai)
   ...
   [查看原文](https://x.com/rohanpaul_ai/status/2102491250515681384)

4. **GPT-6 Sol 与 GPT-6 Luna 在 ChatGPT Work 和 Codex 中推送** — X：ChatGPT (@ChatGPT)
   ...
   [查看原文](https://x.com/ChatGPT/status/2102462020339613966)

5. **Claude Opus 5.5 上线 OpenRouter，智能体编码等能力领先 Opus 5** — X：OpenRouter (@OpenRouter)
   ...
   [查看原文](https://x.com/OpenRouter/status/2102438921213014078)

6. **Qwen-Image-2.1 开源发布，登顶 Arena 图像编辑榜开源第一** — X：Arena (@arena)
   ...
   [查看原文](https://x.com/arena/status/2102416020678008986)

7. **Boris Cherny 实测 Claude Opus 5.5：比 Fable 5.1 快且便宜 51%** — X：Boris Cherny (@bcherny)
   ...
   [查看原文](https://x.com/bcherny/status/2102439069053747549)

8. **Anthropic 发布 Claude Opus 5.5，Claude 5.5 系列首个模型** — X：Claude (@claudeai)
   Anthropic 发布 Claude Opus 5.5，是 Claude 5.5 系列的首个模型。官方称其在多数任务上达到 Claude Fable 5.1 的水平，运行成本比 Opus 5 低 40%。
   [查看原文](https://x.com/claudeai/status/2102435511222890900)

## 📦 产品发布/更新

9. **transformers 支持直接加载 GGUF 量化模型，本地推理性能接近 llama.cpp** — Hugging Face：Blog（RSS）
   ...
   [查看原文](https://huggingface.co/blog/transformers-llama-cpp-quants)

10. **OpenRouter 推出 Batch API，批量推理可享半价** — OpenRouter：Announcements（RSS）
   OpenRouter 发布 Batch API，异步批量请求由供应商在 24 小时窗口内完成，通常按正常 per-token 价格的 50% 或更低收费，目前已支持 70 多个模型。
   [查看原文](https://openrouter.ai/blog/announcements/batch-api)

11. **Kimi 发布浏览器扩展，由 Kimi WebBridge 更名而来** — X：Kimi.ai (@Kimi_Moonshot)
   ...
   [查看原文](https://x.com/Kimi_Moonshot/status/2102352211988865456)

12. **Claude Code v2.1.280 发布，新增 Claude Opus 5.5 为默认 Opus 模型** — Claude Code：GitHub Releases（RSS）
   ...
   [查看原文](https://github.com/anthropics/claude-code/releases/tag/v2.1.280)

13. **LiteParse 9 月更新：PDFium 提速 20-25%，新增视觉定位与 is-complex 路由 API** — LlamaIndex：产品、工程与评测
   ...
   [查看原文](https://www.llamaindex.ai/blog/liteparse-updates-september-2026)

14. **Apple 新款 Mac mini（M6/M5 Pro）与 Mac Studio（M5 Max/M5 Ultra）今日开售** — Apple：Newsroom（RSS）
   Apple 宣布新款 Mac mini 和 Mac Studio 于 9 月 22 日开售。Mac mini 搭载 M6 和 M5 Pro，AI 性能最高提升 4 倍。
   [查看原文](https://www.apple.com/newsroom/2026/09/the-new-mac-mini-and-mac-studio-are-available-today)

15. **OpenAI 为 GPT-6 推出改进的提示词缓存系统与诊断工具** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   OpenAI 为 GPT-6 系列推出改进的提示词缓存系统，默认提高缓存命中率，对 30 分钟窗口内复用的合格共享前缀提供最高 90% 的缓存输入 token 折扣。
   [查看原文](https://openai.com/index/better-prompt-caching-for-gpt-6)

## 🏭 行业动态

16. **五角大楼内部审查：过度依赖 Palantir Maven AI 系统导致误击伊朗学校、123 名儿童死亡** — Hacker News：AI 热帖
   ...
   [查看原文](https://gizmodo.com/pentagon-investigators-say-overreliance-on-palantir-ai-tech-contributed-to-u-s-strike-that-killed-123-iranian-children-2000814477)

17. **Meta Muse 助手曝出严重 0-day 漏洞，Amazon 已开始封禁 Muse** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://arstechnica.com/security/2026/09/muse-metas-extraordinarily-privileged-ai-assistant-has-a-serious-0-day)

18. **Claude Opus 5.5 上架 Arena 的 Agent Arena 与 Battle Mode** — X：Arena (@arena)
   ...
   [查看原文](https://x.com/arena/status/2102454952576868638)

## 📄 论文研究

19. **Epoch AI 研究报告：达到同等 AI 性能的成本每季度下降约 47%** — Epoch AI：研究、数据与评测
   ...
   [查看原文](https://epoch.ai/publications/the-plunging-price-of-thought)

## 💡 技巧与观点

20. **Claude Opus 5.5 登顶 Artificial Analysis 智能指数，得分 58** — Artificial Analysis 完整文章（网页）
   ...
   [查看原文](https://artificialanalysis.ai/articles/claude-opus-5-5)

21. **Artificial Analysis 评测 GPT-6 Sol 和 Luna：成本减半但各评测有升有降** — Artificial Analysis 完整文章（网页）
   Artificial Analysis 评测 GPT-6 Sol 和 Luna，价格约为 GPT-5.6 同名型号的一半，Sol 定价 $2/$10 每百万输入/输出 token，Luna 为 $0.10/$0.50。
   [查看原文](https://artificialanalysis.ai/articles/gpt-6-sol-and-luna-push-the-cost-efficiency-frontier)

22. **卡兹克实测对比 Grok 4.7 与小米 MiMo V2.6：后者成不可能三角版本答案** — 公众号：数字生命卡兹克
   作者实测同日凌晨发布的 Grok 4.7 与小米 MiMo V2.6，认为 Grok 4.7 低于预期，MiMo V2.6 成为性能、价格、速度三角的当前版本答案。
   [查看原文](https://mp.weixin.qq.com/s?__biz=MzIyMzA5NjEyMA%3D%3D&mid=2647686569&idx=1&sn=f716d3dd70259240800a67b9fabd53fd)

23. **Artificial Analysis 评测 Step 5 Preview： Intelligence Index 得 44 分，成本约为同级模型 1/2.8** — X：Artificial Analysis (@ArtificialAnlys)
   ...
   [查看原文](https://x.com/ArtificialAnlys/status/2102213621963243704)

24. **OpenRouter 实测 Jev 1.13 与 Claude Opus 5 在 Banking77 分类任务上的准确率、延迟与成本** — OpenRouter：Announcements（RSS）
   ...
   [查看原文](https://openrouter.ai/blog/insights/jev-vs-claude-opus-5-classification)

25. **OpenRouter 解读 NVIDIA Nemotron 3.5 Lightning 如何承担 Agent 高频执行调用** — OpenRouter：Announcements（RSS）
   ...
   [查看原文](https://openrouter.ai/blog/insights/nemotron-3-5-lightning)

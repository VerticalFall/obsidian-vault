...
type: daily-report
tags: [AI, 日报, ai-hot]
title: 🔥 AI HOT 日报 · 2026-07-03
aliases: [🔥 AI HOT 日报 · 2026-07-03]
linter-yaml-title-alias: 🔥 AI HOT 日报 · 2026-07-03
---
...
1. **AI 版支付宝开放公测，蚂蚁阿宝无需邀请码即可体验** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/971/469.htm)

2. **Google Health API 推出 CLI：ghealth 是一款针对 Fitbit 数据的开源工具** — MarkTechPost（RSS）
   ...
   [查看原文](https://www.marktechpost.com/2026/07/02/the-google-health-api-got-a-cli-ghealth-is-an-open-source-tool-for-your-fitbit-air-data)

3. **Senior SWE-Bench：评估AI智能体作为高级工程师的基准测试** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://senior-swe-bench.snorkel.ai/)

4. **Kimi K2.7 Code 已在 GitHub Copilot 上正式发布** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://github.blog/changelog/2026-07-01-kimi-k2-7-is-now-available-in-github-copilot)

5. **阿里巴巴发布 Page Agent：开源 JavaScript 库实现网页 DOM 自然语言操控** — MarkTechPost（RSS）
   ...
   [查看原文](https://www.marktechpost.com/2026/07/02/meet-alibabas-page-agent-a-javascript-in-page-gui-agent-that-controls-web-interfaces-with-natural-language-through-the-dom)

6. **昆仑万维天工3.2发布Skywork Tags，AI智能体加入工作群聊** — 公众号：昆仑万维（天工）
   ...
   [查看原文](https://mp.weixin.qq.com/s/OqL6ID-mAel8XN-slYgXOA)

7. **Claude Enterprise 新增用量与成本分析及支出管控功能** — Claude：Blog（网页）
   ...
   [查看原文](https://claude.com/blog/giving-admins-more-visibility-and-control-over-claude-usage-and-spend)

## 🏭 行业动态

8. **Microsoft 成立“Frontier Company”，斥资 25 亿美元派驻 6000 名 AI 工程师到企业客户现场** — The Decoder：AI News（RSS）
   ...
   [查看原文](https://the-decoder.com/microsoft-launches-2-5-billion-frontier-company-to-embed-6000-ai-engineers-inside-enterprise-clients)

9. **Anthropic与五角大楼控权之争：Claude军事用途护栏分歧** — X：Kim (@kimmonismus)
   ...
   [查看原文](https://x.com/kimmonismus/status/2072718147279335507)

10. **OpenAI提议美国政府持股5%估值426亿美元** — X：Testing Catalog (@testingcatalog)
   据Financial Times和CNBC报道，OpenAI提议向美国政府提供公司5%的股份，按近期8520亿美元估值计算，价值约426亿美元。OpenAI CEO Sam Altman表示，此举是与公众分享AI发展红利的最佳方式。
   [查看原文](https://x.com/testingcatalog/status/2072585845542969583)

11. **花旗、Adobe等企业限制员工使用AI旗舰模型以控制成本** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/971/937.htm)

12. **快手可灵AI获初始投资者20.28亿美元注资，投后估值180亿美元** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/971/954.htm)

13. **谷歌AI建设导致2025年用电量增长37%** — Ars Technica：AI（RSS）
   ...
   [查看原文](https://arstechnica.com/ai/2026/07/googles-ai-buildout-drove-37-increase-in-electricity-use-in-2025)

## 📄 论文研究

14. **关于Mythos和网络安全的讨论并非炒作** — X：Ethan Mollick (@emollick)
   关于Mythos和网络安全的讨论并非炒作。 （正如任何使用Fable进行自主工作的人可能已经认识到的那样。）
   [查看原文](https://x.com/emollick/status/2072778376494895139)

15. **多智能体团队阻碍专家发挥** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/multi-agent-teams-experts)

16. **RL微调VLM的鲁棒性与思维链一致性研究** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/robustness-chain-thought-consistency)

17. **VideoFlexTok：可变长度粗到细视频分词** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/videoflextok)

## 💡 技巧与观点

18. **browser-use 发布开源 AI 视频剪辑 Skill「video-use」** — X：邵猛 (@shao__meng)
   ...
   [查看原文](https://x.com/shao__meng/status/2072644710523691110)

19. **Emil Kowalski 发布设计工程师 Skills，让 AI 编码工具具备 UI 动画审美** — X：邵猛 (@shao__meng)
   ...
   [查看原文](https://x.com/shao__meng/status/2072484635955900792)

20. **Fable 5 在 RLI 基准中达成 16.1% 自动化率，较八个月前提升六倍** — The Decoder：AI News（RSS）
   ...
   [查看原文](https://the-decoder.com/ai-agents-can-now-complete-16-percent-of-freelance-jobs-at-pro-quality-up-from-2-5-percent-eight-months-ago)

21. **Fable 5 仅 4.44 美元搭建 Rube Goldberg 机器** — X：OpenRouter (@OpenRouter)
   ...
   [查看原文](https://x.com/OpenRouter/status/2072738704922439689)

22. **千问团队朱达：C端Agent Harness的“多快好省”工程哲学与主动服务探索** — 公众号：千问APP（阿里）
   ...
   [查看原文](https://mp.weixin.qq.com/s/l70iUM0bIpG9EdV9Px7QPQ)

23. **Agent辅助的SGLang开发：初步探索** — LMSYS：Blog（Chatbot Arena 团队）
   ...
   [查看原文](https://www.lmsys.org/blog/2026-07-02-agent-assisted-sglang-development)

24. **借用夜晚：将闲置推理GPU回收用于研究** — Runway：News（网页）
   ...
   [查看原文](https://runwayml.com/news/borrowing-the-night-reclaiming-idle-inference-gpus-for-research)

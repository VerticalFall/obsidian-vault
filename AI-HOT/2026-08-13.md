...
2. **阿里开放 Qwen3.8-2.4T-A95B 模型权重：2.4T MoE、激活 95B、原生 256K 上下文** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/989/001.htm)
...
3. **LTX-2.5 模型登场：AI 生成 10 秒 720P 视频仅需 6.8 秒，原生集成 ComfyUI** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/988/766.htm)

4. **微软首发自研推理模型MAI-Thinking-1** — X：Mustafa Suleyman（Microsoft AI CEO） (@mustafasuleyman)
   我们的首个推理模型 MAI-Thinking-1 从零开始构建，现已在 Microsoft Foundry 上线。为团队点赞！更多详情如下。
   [查看原文](https://x.com/mustafasuleyman/status/2087570047967408396)
...
5. **OpenRouter 推出实时网页搜索基准测试：如何为智能体选择引擎、深度与模型** — OpenRouter：Announcements（RSS）
   ...
   [查看原文](https://openrouter.ai/blog/announcements/web-search-benchmark)
...
6. **Claude in Chrome 侧边栏升级为 Claude Cowork 会话** — Claude：Blog（网页）
   ...
   [查看原文](https://claude.com/blog/cowork-chrome-side-panel)
...
7. **SGLang 与 Miles 为 Qwen3.8-2.4T-A95B 提供 Day-0 支持** — LMSYS：Blog（Chatbot Arena 团队）
   ...
   [查看原文](https://www.lmsys.org/blog/2026-08-12-qwen3-8-day0-support)
...
8. **WhatsApp 如何用端到端加密与可验证性构建 Scam Alert 诈骗提醒功能** — Meta Engineering Blog（RSS）
   ...
   [查看原文](https://engineering.fb.com/2026/08/12/security/how-were-building-scam-alert-whatsapp)
...
9. **Claude Code v2.1.229 发布：新增远程会话恢复、插件市场命令源及多项修复** — Claude Code：GitHub Releases（RSS）
   ...
   [查看原文](https://github.com/anthropics/claude-code/releases/tag/v2.1.229)
...
10. **Research Gold 号称“100%人类撰写、绝不使用AI”，实则全程由AI驱动** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://www.404media.co/company-offering-100-human-written-never-ai-peer-review-is-entirely-ai)
...
11. **RingCentral 如何用 ChatGPT Work 和 Codex 构建 AI 原生工作流** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   ...
   [查看原文](https://openai.com/index/ringcentral)
...
12. **空货架还是丢钥匙？Google 研究：Recall 是参数化事实性的瓶颈** — Google Research：Blog（网页）
   ...
   [查看原文](https://research.google/blog/empty-shelves-or-lost-keys-recall-is-the-bottleneck-for-parametric-factuality)
...
13. **Anthropic 联合独立研究者发布工人再培训项目证据综述** — Anthropic：Research（发表成果 · 网页）
   ...
   [查看原文](https://www.anthropic.com/research/reviewing-the-evidence-on-worker-retraining-programs)
...
14. **零基础用户半天上手AI的12步实操流程** — 公众号：数字生命卡兹克
   ...
   [查看原文](https://mp.weixin.qq.com/s?__biz=MzIyMzA5NjEyMA%3D%3D&mid=2647685084&idx=1&sn=0899296dbc140eeb745f7a99f9d5ed9c)
...
15. **DeepSeek V4 Pro与Grok 4.6同日发布，双双逼近Claude Fable 5体验** — 公众号：数字生命卡兹克
   ...
   [查看原文](https://mp.weixin.qq.com/s?__biz=MzIyMzA5NjEyMA%3D%3D&mid=2647685175&idx=1&sn=64c383b5b757945397894270c5f38301)
...
16. **AutoGPT 如何用 AGENTS.md 和技能门控管理 AI 生成的拉取请求** — GitHub Blog
   ...
   [查看原文](https://github.blog/open-source/maintainers/your-contributors-are-ai-first-now-is-your-project)
...
17. **我写了一本 AI 教科书——AI 还要多久才能写得更好？** — Nathan Lambert：Interconnects（RSS）
   ...
   [查看原文](https://www.interconnects.ai/p/i-wrote-an-ai-textbook-how-long-until)
...
18. **OpenRouter 工具调用指南：一次编写循环，切换模型字符串即可跨模型运行** — OpenRouter：Announcements（RSS）
   ...
   [查看原文](https://openrouter.ai/blog/tutorials/tool-calling)
...
19. **LangChain 详解：什么是 AI 智能体？** — LangChain：Blog（RSS）
   ...
   [查看原文](https://www.langchain.com/blog/what-is-an-agent)

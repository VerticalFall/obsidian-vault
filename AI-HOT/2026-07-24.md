...
# 🔥 AI HOT 日报 · 2026-07-24

## 🧠 模型发布/更新

1. **Cactus 发布 Gemma 4 E2B Hybrid：可在设备端为每个回答输出置信度分数，低分时自动路由至更大模型** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://github.com/cactus-compute/cactus-hybrid)

## 📦 产品发布/更新

2. **ChatGPT 桌面版上线语音控制多智能体** — X：OpenAI (@OpenAI)
   ...
   [查看原文](https://x.com/OpenAI/status/2080378182469857576)

3. **Claude 语音模式现已支持 Opus、Sonnet 及连接工具与多语言** — Claude：Blog（网页）
   ...
   [查看原文](https://claude.com/blog/think-through-hard-problems-in-voice-mode)

4. **OpenAI 在 ChatGPT 中推出 Health 功能，支持连接医疗记录与 Apple Health** — OpenAI：官网动态（RSS · 排除企业/客户案例）
   OpenAI 面向符合条件的美国用户推出 ChatGPT Health 功能，可安全连接医疗记录与 Apple Health 数据，提供更个性化的健康洞察。该功能旨在帮助用户更好地理解自身健康状况。
   [查看原文](https://openai.com/index/health-in-chatgpt)

## 🏭 行业动态

5. **佛州男子因相信 ChatGPT 拒绝就医而险些丧命，起诉 OpenAI 及 CEO 奥尔特曼** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/980/890.htm)

6. **DARPA 与美国空军试飞 AI 操控的 F-16 战机** — Hacker News 热门（buzzing.cc 中文翻译）
   DARPA 与美国空军成功试飞了由人工智能操控的 F-16 战机。该 AI 系统在真实空战环境中完成了自主飞行与战术机动测试，标志着 AI 在军事航空领域的重大进展。
   [查看原文](https://www.darpa.mil/news/2026/darpa-us-air-force-fly-ai-controlled-f-16)

7. **Google Gemini 月活用户逼近 9.5 亿，有望成为下一个十亿级产品** — TechCrunch：AI（RSS）
   ...
   [查看原文](https://techcrunch.com/2026/07/23/google-closes-in-on-another-billion-user-product-with-gemini)

8. **OpenAI Workspace Agents 漏洞：一个 ChatGPT 链接即可创建恶意 AI 智能体** — The Decoder：AI News（RSS）
   ...
   [查看原文](https://the-decoder.com/one-tampered-chatgpt-link-could-spawn-a-rogue-ai-agent-that-took-orders-from-an-attacker-every-five-minutes)

## 📄 论文研究

9. **小红书HELMSMAN：全闪存服务器实现高性能向量检索，硬件成本节省超90%** — 公众号：小红书技术（dots.llm）
   ...
   [查看原文](https://mp.weixin.qq.com/s/WCYE6itbTBPU0Q_3BfQxkA)

10. **AISI 报告 GPT-5.6 Sol 等 5 款 AI 模型均存“作弊”行为** — IT之家（RSS）
...
11. **TheNumbers.com 因 AI 爬虫与安全攻击导致网站崩溃重建** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://stephenfollows.com/p/what-just-happened-to-thenumberscom-should-worry-us-all)

12. **Apple 起诉 OpenAI 窃取硬件制造机密** — The Verge：AI（RSS）
   ...
   [查看原文](https://www.theverge.com/podcast/968787/apple-openai-trade-secrets-lawsuit-ai-hardware-smartphone-jony-ive)

13. **昆仑万维方汉：Token堆不出AI原生组织，模型才是长期立足之本** — 公众号：昆仑万维（天工）
   ...
   [查看原文](https://mp.weixin.qq.com/s/TEAuv29LPgmjQG_rO3b_Ag)

14. **北京发布智能体新政，首次将Harness Engineering、Token经济、OPC等写入政策** — 公众号：数字生命卡兹克
   ...
   [查看原文](https://mp.weixin.qq.com/s/CYB7v1e5D4m-btgosjmLgA)

15. **微软MAI模型：以更低成本实现前沿能力规模化** — X：Satya Nadella (@satyanadella)
   ...
   [查看原文](https://x.com/satyanadella/status/2080329851127669104)

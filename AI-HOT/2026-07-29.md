...
# 🔥 AI HOT 日报 · 2026-07-29

## 🧠 模型发布/更新

1. **Microsoft 发布 MAI-Cyber-1-Flash：5B 活跃参数的网络安全模型，驱动 MDASH 在 CyberGym 上达到 95.95%** — MarkTechPost（RSS）
   Microsoft 发布 MAI-Cyber-1-Flash，一款 137B 总参数（5B 活跃参数）、256k 上下文窗口的稀疏 MoE 网络安全模型，是 MAI-Code-1-Flash 的微调版本。
   [查看原文](https://www.marktechpost.com/2026/07/28/microsoft-ai-releases-mai-cyber-1-flash-a-5b-active-parameter-cyber-model-that-pushes-mdash-to-95-95-on-cybergym)

2. **FeyNoBg 发布：开源自动背景去除模型，在四项基准上达到 SOTA** — Hacker News 热门（buzzing.cc 中文翻译）
   ...
   [查看原文](https://usefeyn.com/blog/feynobg)

3. **OpenAI 推出两款新转录模型 API** — X：OpenAI Developers (@OpenAIDevs)
   ...
   [查看原文](https://x.com/OpenAIDevs/status/2082201169443905798)

## 📦 产品发布/更新

4. **OpenAI 发布 Codex 安全 CLI 与 SDK** — X：Tibo (@thsottiaux)
   ...
   [查看原文](https://x.com/thsottiaux/status/2082241164850364555)

5. **Gemini API Managed Agents 默认升级为 3.6 Flash，新增环境钩子与免费套餐** — Google Blog：AI（RSS）
   ...
   [查看原文](https://blog.google/innovation-and-ai/technology/developers-tools/expanding-managed-agents-gemini-api-3-6-flash-hooks)

6. **Perplexity 推出 Windows 版个人电脑智能体** — X：Perplexity (@perplexity_ai)
   ...
   [查看原文](https://x.com/perplexity_ai/status/2082103880155046176)

7. **火山引擎上线豆包搜索服务，为AI Agent提供实时可信搜索能力** — 公众号：火山引擎
   ...
   [查看原文](https://mp.weixin.qq.com/s/1nZqQHYqclsIF6__WLscgA)

8. **Cursor 在印度推出 Cursor Start 计划，含 Grok 4.5 和 Composer，月费 ₹649** — Cursor Blog
   ...
   [查看原文](https://cursor.com/blog/cursor-start-india)

## 🏭 行业动态

9. **Hugging Face 公开自主智能体网络攻击详情** — X：Clément Delangue（Hugging Face CEO） (@ClementDelangue)
   ...
   [查看原文](https://x.com/ClementDelangue/status/2082201245813514613)

10. **Andrew Ng 创办 LearnVector，用 AI 实现一对一学习** — X：Andrew Ng（DeepLearning.AI 创始人） (@AndrewYNg)
   ...
   [查看原文](https://x.com/AndrewYNg/status/2082199333920027009)

11. **OpenAI 失控模型二次入侵 Modal 客户** — X：AI Safety Memes (@AISafetyMemes)
   ...
   [查看原文](https://x.com/AISafetyMemes/status/2082223372214448303)

12. **德里高等法院裁定 OpenAI 利用 ANI 内容训练 AI 未侵犯版权** — IT之家（RSS）
   ...
   [查看原文](https://www.ithome.com/0/982/520.htm)

13. **Anthropic 支持 AI 发展节奏请愿** — X：Anthropic (@AnthropicAI)
   ...
   [查看原文](https://x.com/AnthropicAI/status/2082228994653696371)

## 📄 论文研究

14. **Kimi Linear：一种表现力强且高效的注意力架构** — Hacker News 热门（buzzing.cc 中文翻译）
...
15. **Claude 发现加密算法弱点研究发布** — X：Anthropic (@AnthropicAI)
   ...
   [查看原文](https://x.com/AnthropicAI/status/2082153297670992134)

16. **Apple 为 Siri Expressive Voices 推出内存高效的音频合成架构** — Apple Machine Learning Research（RSS）
   ...
   [查看原文](https://machinelearning.apple.com/research/audio-synthesis-diffusion-transformers)

## 💡 技巧与观点

17. **Sam Altman 态度转变：AI 发展或需“减速”以让社会做好准备** — TechCrunch：AI（RSS）
...
18. **OpenAI 呼吁为前沿AI发展设定节奏** — X：OpenAI (@OpenAI)
   ...
   [查看原文](https://x.com/OpenAI/status/2082208694142730340)

19. **Google Search 的 AI Mode 推出 5 项新功能，帮你规划线下生活** — Google Blog：AI（RSS）
   ...
   [查看原文](https://blog.google/products-and-platforms/products/search/ai-mode-real-world-tips)

20. **如何评估不同 LLM 提供商在延迟、吞吐量和正常运行时间上的性能** — OpenRouter：Announcements（RSS）
   同一模型在不同提供商端点上的表现因基础设施、量化、负载处理和路由默认设置而异。评估需测量延迟、吞吐量、正常运行时间和精度，并将测量结果转化为路由策略。
   [查看原文](https://openrouter.ai/blog/insights/evaluate-llm-provider-performance)

21. **Databricks 发布 Genie One：面向业务用户的 AI 协同工作助手** — Databricks：Blog（RSS）
   ...
   [查看原文](https://www.databricks.com/blog/get-started-genie-one-top-ai-cowork-use-cases-business-users)

22. **AI 框架（Harness）对模型性能的影响超过模型本身：GPT-5.5 在 Cursor 上得分 87.2%，比 Codex 高 25.7 个百分点** — Tomer Tunguz 博客（VC 分析）
   ...
   [查看原文](https://www.tomtunguz.com/aftermarket-harnesses)

23. **LangChain 如何构建 Agent-First 数据栈：自服务分析规模提升 40 倍** — LangChain：Blog（RSS）
   ...
   [查看原文](https://www.langchain.com/blog/agent-data-stack)

24. **NVIDIA Jetson 为边缘 AI 和机器人提供紧凑型开发套件** — NVIDIA Blog（RSS）
   ...
   [查看原文](https://blogs.nvidia.com/blog/build-ai-with-nvidia-jetson)
